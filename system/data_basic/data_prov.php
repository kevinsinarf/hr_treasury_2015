...
$filter = "";
if($s_name != ""){
	$filter .= " and (PROV_TH_NAME like '%".ctext($s_name)."%' OR PROV_EN_NAME like '%".ctext($s_name)."%') ";
}
if($s_status != ""){
	$filter .= " and ACTIVE_STATUS = '".ctext($s_status)."' ";
}

$field="PROV_ID,PROV_TH_NAME,PROV_EN_NAME,ACTIVE_STATUS";
$table="SETUP_PROV";
$pk_id="PROV_ID";
$wh="DELETE_FLAG='0' {$filter}";
$orderby="order by ACTIVE_STATUS desc, PROV_ID ASC";
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-1" style="white-space:nowrap;"><?php echo  $arr_txt['prov'];?> :</div>
			<div class="col-xs-12 col-sm-3"><input type="text" id="s_name" name="s_name" class="form-control" placeholder="<?php echo  $arr_txt['prov'];?>" value="<?php echo $s_name; ?>"></div>
            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="30%"><div align="center"><strong><?php echo  $arr_txt['prov']?> (<?php echo $arr_txt['th'];?>)</strong> </div></th>
                  <th width="30%"><div align="center"><strong><?php echo  $arr_txt['prov']?> (<?php echo $arr_txt['en'];?>)</strong> </div></th>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						...
						if(chkPermission($menu_sub_id, 'edit')=='1'){
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["PROV_ID"]."');\">".$img_edit." แก้ไข</a> ";
						}
						if(chkPermission($menu_sub_id, 'delete')=='1'){
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["PROV_ID"]."');\">".$img_del." ลบ</a> ";
						}
				?>
                <tr bgcolor="#FFFFFF">
                  <td align="center"><?php echo $i+$goto; ?>.</td>
                  <td align="left"><?php echo text($rec["PROV_TH_NAME"]); ?></td>
                  <td align="left"><?php echo text($rec["PROV_EN_NAME"]); ?></td>
