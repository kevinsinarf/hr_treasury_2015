...
$COUNTRY_NAME_TH=trim($_POST['COUNTRY_NAME_TH']);
$COUNTRY_NAME_EN=trim($_POST['COUNTRY_NAME_EN']);
$ACTIVE_STATUS=$_POST['ACTIVE_STATUS'];


$url_back="../data_country.php";
$table="SETUP_COUNTRY";
...
switch($proc){
	case "add" : 
		try{
			unset($fields);
			$fields = array(
				"COUNTRY_NAME_TH" => ctext($COUNTRY_NAME_TH),
				"COUNTRY_NAME_EN" => strtoupper(ctext($COUNTRY_NAME_EN)),
	...
	case "edit" : 
		try{
			...
			$db->db_update($table,$fields," COUNTRY_ID = '".$COUNTRY_ID."' "); 
	...
	case "delete" : 
		try{	
			$db->db_delete($table," COUNTRY_ID = '".$COUNTRY_ID."' ");
