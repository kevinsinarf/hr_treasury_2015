...
if($MOVEMENT_TYPE != ""){
	$filter .= " and MOVEMENT_TYPE = '".$MOVEMENT_TYPE."' ";
}
...
<script src="js/data_profile_history_disp.js?<?php echo rand(); ?>"></script>
</head>
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
        ...
        <input type="hidden" id="POSTYPE_ID" name="POSTYPE_ID" value="">
        ...
        <div class="row">
                ...
                <div class="col-xs-12 col-sm-2" style="white-space:nowrap;">วิธีการบันทึกลง ก.พ. </div>
                <div class="col-xs-12 col-sm-3">
                <?php echo GetHtmlSelect('MOVEMENT_TYPE','MOVEMENT_TYPE',$arr_kr,'ิธีการบันทึกลง ก.พ.',$MOVEMENT_TYPE,'','','1','','2');?>
                </div>
        </div>
            ...
            <table width="397" class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="25%"><div align="center"><strong>ชื่อเรื่องคำสั่งภาษาไทย</strong> </div></th>
                  <th width="15%"><div align="center"><strong>ชื่อเรื่องคำสั่งภาษาอังกฤษ</strong> </div></th>
                  <th width="15%"><div align="center"><strong>วิธีการบันทึก ก.พ. 7</strong> </div></th>
					...
					while($rec = $db->db_fetch_array($query)){
						...
						<tr bgcolor="#FFFFFF">
						  ...
						  <td align="left"><?php echo text($rec['MOVEMENT_NAME_EN']);   ?></td>				  
                           <td align="left"><?php echo $arr_kr[$rec['MOVEMENT_TYPE']]; ?></td>
