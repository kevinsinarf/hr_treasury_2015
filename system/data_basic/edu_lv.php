...
$filter = "";
if($s_name != ""){
	$filter .= " and (EL_NAME_TH like '%".ctext($s_name)."%' OR EL_NAME_EN like '%".ctext($s_name)."%') ";
}
if($s_status != ""){
	$filter .= " and ACTIVE_STATUS = '".ctext($s_status)."' ";
}

$field="EL_ID,EL_NAME_TH,EL_NAME_EN,ACTIVE_STATUS";
$table="SETUP_EDU_LEVEL";
$pk_id="EL_ID";
$wh="DELETE_FLAG='0' {$filter}";
$orderby="order by ACTIVE_STATUS desc, EL_ID ASC";
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
        ...
        <input type="hidden" id="EL_ID" name="EL_ID" value="">
		<div class="row">
			<div class="col-xs-12 col-sm-1" style="white-space:nowrap;"><?php echo $arr_data['edu_lv'];?> :</div>
			<div class="col-xs-12 col-sm-3"><input type="text" id="s_name" name="s_name" class="form-control" placeholder="<?php echo $arr_data['edu_lv'];?>" value="<?php echo $s_name; ?>"></div>
            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="30%"><div align="center"><strong><?php echo $arr_data['edu_lv']?> (<?php echo $arr_txt['th'];?>)</strong> </div></th>
                  <th width="30%"><div align="center"><strong><?php echo $arr_data['edu_lv']?> (<?php echo $arr_txt['en'];?>)</strong> </div></th>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						...
						if(chkPermission($menu_sub_id, 'edit')=='1'){
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["EL_ID"]."');\">".$img_edit." แก้ไข</a> ";
						}
						if(chkPermission($menu_sub_id, 'delete')=='1'){
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["EL_ID"]."');\">".$img_del." ลบ</a> ";
						}
				?>
                <tr bgcolor="#FFFFFF">
                  <td align="center"><?php echo $i+$goto; ?>.</td>
                  <td align="left"><?php echo text($rec["EL_NAME_TH"]); ?></td>
                  <td align="left"><?php echo text($rec["EL_NAME_EN"]); ?></td>
