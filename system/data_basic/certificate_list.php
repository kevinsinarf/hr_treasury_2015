...
$filter = "";
if($s_name != ""){
	$filter .= " and (CERTIFICATE_NAME_TH like '%".ctext($s_name)."%' OR CERTIFICATE_NAME_EN like '%".ctext($s_name)."%') ";
	$filter .= " OR (CERTIFICATE_SHORTNAME_TH like '%".ctext($s_name)."%' OR CERTIFICATE_SHORTNAME_EN like '%".ctext($s_name)."%') ";
}
if($s_status != ""){
	$filter .= " and ACTIVE_STATUS = '".ctext($s_status)."' ";
}

$field="CERTIFICATE_ID,CERTIFICATE_CODE,CERTIFICATE_NAME_TH,CERTIFICATE_NAME_EN,ACTIVE_STATUS,CERTIFICATE_BY";
$table="SETUP_CERTIFICATE";
$pk_id="CERTIFICATE_ID";
$wh="DELETE_FLAG='0' {$filter}";
$orderby="order by ACTIVE_STATUS desc, CERTIFICATE_ID ASC";
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12">
    ...
    <div class="groupdata">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-1" style="white-space:nowrap;">ใบประกอบวิชาชีพ :</div>
			<div class="col-xs-12 col-sm-3"><input type="text" id="s_name" name="s_name" class="form-control" placeholder="ใบประกอบวิชาชีพ" value="<?php echo $s_name; ?>"></div>
            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <?php /*<th width="5%"><div align="center"><strong>CODE</strong> </div></th> */ ?>
                  <th width="15%"><div align="center"><strong>ชื่อใบประกอบวิชาชีพ (<?php echo $arr_txt['th'];?>)</strong> </div></th>
                  <th width="15%"><div align="center"><strong>ชื่อใบประกอบวิชาชีพ (<?php echo $arr_txt['en'];?>)</strong> </div></th>
                  <th width="10%"><div align="center"><strong>หน่วยงานที่ออกให้</strong></div></th>
                  <th width="8%"><div align="center"><strong><?php echo $arr_txt['active']?></strong></div></th>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						...
						if(chkPermission($menu_sub_id, 'edit')=='1'){
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["CERTIFICATE_ID"]."');\">".$img_edit." แก้ไข</a> ";
						}
						if(chkPermission($menu_sub_id, 'delete')=='1'){
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["CERTIFICATE_ID"]."');\">".$img_del." ลบ</a> ";
						}
				?>  
                <tr bgcolor="#FFFFFF">
                  <td align="center"><?php echo $i+$goto; ?>.</td>
                 <?PHP /* <td align="left"><?php echo text($rec["CERTIFICATE_CODE"]); ?></td> */ ?>
                  <td align="left"><?php echo text($rec["CERTIFICATE_NAME_TH"]); ?></td>
                  <td align="left"><?php echo text($rec["CERTIFICATE_NAME_EN"]); ?></td>
                  <td align="left"><?php echo text($rec["CERTIFICATE_BY"]); ?></td>
    ...
    <div style="text-align:center; bottom:0px;"><br/><br/><br/><br/><?php include($path."include/footer.php"); ?></div>
</div>
  </body>
</html>