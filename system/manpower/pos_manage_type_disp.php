...
$filter = "";
if(trim($s_name_th) != ""){
	$filter .= " and MT_NAME_TH like '%".ctext(trim($s_name_th))."%' ";
}
if(trim($s_name_en) != ""){
	$filter .= " and MT_NAME_EN like '%".ctext(trim($s_name_en))."%' ";
}

$field="MT_ID, MT_TYPE, MT_NAME_TH,MT_NAME_EN,ACTIVE_STATUS";
$table="SETUP_POS_MANAGE_TYPE ";
$pk_id="MT_ID";
$wh=" ACTIVE_STATUS='1' and DELETE_FLAG='0'  {$filter} ";
$orderby="order by MT_SEQ ASC ";
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
      <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-3" style="white-space:nowrap;">ชื่อประเภทตำแหน่งทางการบริหาร(ไทย) :</div>
				...
				<table class="table table-bordered table-striped table-hover table-condensed">
				  <thead>
					<tr class="bgHead">
					  ...
					  <th width="30%"><div align="center"><strong>ชื่อประเภทตำแหน่งทางการบริหารภาษาไทย</strong> </div></th>
					  <th width="30%"><div align="center"><strong>ชื่อประเภทตำแหน่งทางการบริหารภาษาอังกฤษ</strong> </div></th>
                      <th width="15%"><div align="center"><strong>สถานะของตำแหน่งผู้บริหาร</strong> </div></th>
				  ...
				  <tbody>
					...
					if($nums > 0){
						...
						while($rec = $db->db_fetch_array($query)){
							...
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["MT_ID"]."');\">".$img_edit." แก้ไข</a> ";
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["MT_ID"]."');\">".$img_del." ลบ</a> ";
					?>
					<tr bgcolor="#FFFFFF">
					  <td align="center"><?php echo $i+$goto; ?>.</td>
					  <td align="left"><?php echo text($rec["MT_NAME_TH"]); ?></td>
					  <td align="left"><?php echo text($rec["MT_NAME_EN"]); ?></td>
                      <td align="left"><?php echo $arr_type[$rec["MT_TYPE"]]; ?></td>
