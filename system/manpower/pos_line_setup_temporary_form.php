...
$page_back = "pos_line_setup_temporary_disp.php";
...
<script src="js/pos_line_setup_temporary_form.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
	...
	<div class="clearfix"></div>
      <form id="frm-input" method="post" action="process/pos_line_setup_temporary_process.php" enctype="multipart/form-data">
		...
		<div class="row formSep">
			...
			<div class="col-xs-12 col-md-2"><input type="text" id="LINE_NAME_TH" name="LINE_NAME_TH" class="form-control"  placeholder="ชื่อตำแหน่งในสายงานภาษาไทย" maxlength="100" value="<?php echo text($data["LINE_NAME_TH"]); ?>"onKeyUp="chkDup('chkDup1','flagDup1','LINE_NAME_TH','LINE_ID','SETUP_POS_LINE','');"></div>
        ...
        <div class="row formSep">   
			...
			<div class="col-xs-12 col-md-2"><input type="text" id="LINE_NAME_EN" name="LINE_NAME_EN" class="form-control" placeholder="ชื่อตำแหน่งในสายงานภาษาอังกฤษ" maxlength="100" value="<?php echo text($data["LINE_NAME_EN"]); ?>" onKeyUp="chkDup('chkDup3','flagDup3','LINE_NAME_EN','LINE_ID','SETUP_POS_LINE','');" ></div>
