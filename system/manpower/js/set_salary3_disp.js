...
function add_row(){
	...
	table.rows[rowCount].cells[2].innerHTML="<input type=\"text\" id=\"SAL_DAY_"+id_tb+"\" name=\"SAL_DAY[]\"  class=\"form-control\" maxlength=\"6\" style=\"width:120px;text-align:right;\" onBlur=\"NumberFormat(this,2)\">";
	table.rows[rowCount].cells[3].innerHTML="<input type=\"text\" id=\"SAL_HOURS_"+id_tb+"\" name=\"SAL_HOURS[]\"  class=\"form-control\" maxlength=\"6\" style=\"width:120px;text-align:right;\" onBlur=\"NumberFormat(this,2)\">";
...
function chkinput(){
	...
	if(confirm("กรุณายืนยันการบันทึกอีกครั้ง ?")){
		...
		$("#frm-search").attr('action','process/set_salary3_process.php').submit();
	}
}
