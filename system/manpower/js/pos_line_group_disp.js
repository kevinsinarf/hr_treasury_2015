var form_input = "pos_line_group_form.php";
...
function addData(){
	$("#proc").val("add");
	$("#frm-search").attr("action","pos_line_group_form.php" ).submit();
}
...
function delData(id){
	if(confirm("ต้องการลบข้อมูลใช่หรือไม่ ?")){
		$("#proc").val("delete");
		$("#LG_ID").val(id);
		$("#frm-search").attr("action","process/pos_line_group_process.php").submit();
	}
}
