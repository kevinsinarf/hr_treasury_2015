...
$field="a.LEVEL_ID,a.LEVEL_NAME_TH,a.LEVEL_NAME_EN,b.TYPE_NAME_TH as TYPE_NAME,a.ACTIVE_STATUS, a.LEVEL_SEQ ";
$table="SETUP_POS_LEVEL a
INNER JOIN SETUP_POS_TYPE b ON a.TYPE_ID = b.TYPE_ID";
$pk_id="a.LEVEL_ID";
$wh="a.DELETE_FLAG='0' and a.POSTYPE_ID = '5' {$filter}";
$orderby="order by b.TYPE_SEQ, a.LEVEL_SEQ";
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3"><?php echo GetHtmlSelect('sTYPE_ID','sTYPE_ID',$arr_type,'กลุ่มงาน',$sTYPE_ID,'','','1',350);?></div>
        </div> 
                    
		<div class="row">
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อระดับตำแหน่งภาษาไทย :</div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name_th" name="s_name_th" class="form-control" placeholder="ชื่อระดับตำแหน่งภาษาไทย" value="<?php echo $s_name_th; ?>"></div>
            <div class="col-xs-12 col-md-2"></div>
            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อระดับตำแหน่งภาษาอังกฤษ :</div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name_en" name="s_name_en" class="form-control" placeholder="ชื่อระดับตำแหน่งภาษาอังกฤษ" value="<?php echo $s_name_en; ?>"></div>
        </div>
       ...
       <div class="row" style="color:red;">
           <div class="col-xs-12 col-sm-12"> * กรมบัญชีกลาง กำหนดคุณสมบัติเฉพาะตำแหน่งและอัตราค่าจ้างขั้นต่ำ-ขั้นสูง ตาม กค 0428/2554 ลว 2 ก.ย. 53 </div>
       </div>
            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="20%"><div align="center"><strong>กลุ่มงาน</strong></div></th>
                  <th width="20%"><div align="center"><strong>ชื่อระดับตำแหน่งภาษาไทย</strong></div></th>
                  <th width="20%"><div align="center"><strong>ชื่อระดับตำแหน่งภาษาอังกฤษ</strong></div></th>
