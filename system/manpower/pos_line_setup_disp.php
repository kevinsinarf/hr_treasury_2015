            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="20%"><div align="center"><strong>สายงาน</strong></div></th>
                  ...
                  <th width="15%"><div align="center"><strong>จัดการ</strong></div></th>
                </tr>
				</thead>
				<tbody>
				<?php
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
							$salary = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"addStepSalary('".$rec["LINE_ID"]."');\">".$img_save." ขั้นค่าจ้าง</a> ";
                ...
                <tr bgcolor="#FFFFFF">
                  ...
                  <td align="center"><?php echo $salary.$edit.$delete; ?></td>
                </tr>
                <?php 
                        $i++;
					}
