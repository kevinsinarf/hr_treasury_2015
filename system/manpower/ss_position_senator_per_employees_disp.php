...
<script src="js/ss_position_senator_per_employees_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4 col-md-3">                                        
						<select id="S_LINE_ID" name="S_LINE_ID" class="selectbox form-control" placeholder="-ทั้งหมด-" >
							...
							$sql_line_name="SELECT LINE_ID , LINE_NAME_TH FROM SETUP_POS_LINE WHERE ACTIVE_STATUS = '1' AND DELETE_FLAG = '0' AND POSTYPE_ID = '$POSTYPE_ID'".$cond_type." ORDER BY LINE_NAME_TH ASC";
