...
$pk_id="a.SKILLSET_ID";
$wh="a.DELETE_FLAG='0' AND SKILL_SET_TYPE = 1 {$filter}";
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
		...
		<div class="row">
                <div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ปีที่ใช้หัวข้อทักษะ :</div>
                    ...
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ชื่อหัวข้อทักษะจำเป็นในงาน :</div>
                    <div class="col-xs-12 col-sm-3">
                     <select id="s_skilltitle_id" name="s_skilltitle_id" class="selectbox form-control" placeholder="ชื่อหัวข้อทักษะจำเป็นในงาน">
                      <option value=""></option>
              ...
              <thead>
                <tr class="bgHead">
                  <th width="5%"><div align="center"><strong>ลำดับ</strong></div></th>
                    <th width="8%" ><div align="center">ปีที่ใช้หัวข้อทักษะ</div></th>
                    <th width="20%" ><div align="center"><strong>ชื่อหัวข้อทักษะจำเป็นในงาน</strong></div></th>
