...
$filter = "";
if($s_name != ""){
	$filter .= " and (SKILLTITLE_NAME_TH like '%".ctext($s_name)."%' OR SKILLTITLE_NAME_EN like '%".ctext($s_name)."%') ";
}
if($s_status != ""){
	$filter .= " and ACTIVE_STATUS = '".ctext($s_status)."' ";
}

$field="SKILLTITLE_ID,SKILLTITLE_NAME_TH,SKILLTITLE_NAME_EN,ACTIVE_STATUS ";
$table="SKILL_TITLE";
$pk_id="SKILLTITLE_ID";
$wh="DELETE_FLAG='0' AND SKILL_TYPE = 2 {$filter}";
$orderby="order by  ACTIVE_STATUS DESC,SKILLTITLE_NAME_TH ASC ";
  ...
  <div class="col-xs-12 col-sm-12" id="content">
   <?php include("tab_skill.php");?>
    <div class="grouptab">
        ...
        <input type="hidden" id="SKILLTITLE_ID" name="SKILLTITLE_ID" value="">
        
		<div class="row">
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อหัวข้อความรู้จำเป็นในงาน :</div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name" name="s_name" class="form-control" placeholder="หัวข้อความรู้จำเป็นในสายงาน" value="<?php echo $s_name; ?>"></div>
              ...
              <thead>
                <tr class="bgHead">
                  <th width="5%"><div align="center"><strong>ลำดับ</strong></div></th>
                     <th width="30%"><div align="center"><strong>ชื่อหัวข้อความรู้จำเป็นในงาน (<?php echo $arr_txt['th'] ;?>)</strong></div></th>
                     <th width="30%"><div align="center"><strong>ชื่อหัวข้อความรู้จำเป็นในงาน (<?php echo $arr_txt['en'] ;?>)</strong></div></th>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						...
						if(chkPermission($menu_sub_id, 'edit')=='1'){
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["SKILLTITLE_ID"]."');\">".$img_edit." แก้ไข</a> ";
						}
						if(chkPermission($menu_sub_id, 'delete')=='1'){
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["SKILLTITLE_ID"]."');\">".$img_del." ลบ</a> ";
						}
				?>
                <tr bgcolor="#FFFFFF">
                  <td align="center"><?php echo $i+$goto; ?>.</td>
                  <td align="left"><?php echo text($rec["SKILLTITLE_NAME_TH"]); ?></td>
                  <td align="left"><?php echo text($rec["SKILLTITLE_NAME_EN"]); ?></td>
