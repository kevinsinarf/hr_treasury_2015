...
$filter = "";
$field=" * ";
$table="SETUP_MANPOWER_BUDGET";

$pk_id="MAN_BDG_ID";
$wh = " ACTIVE_STATUS='1' AND DELETE_FLAG='0' {$filter} ";
$orderby=" ORDER BY MAN_BDG_ID  ASC";
$notin=$wh;
...
<script src="js/man_budget_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
						...
						<table class="table table-bordered table-striped table-hover">
							<thead>
								<tr class="bgHead">
									...
									<th nowrap width="70%"><div align="center">แหล่งของเงิน</div></th>
							...
							if($nums > 0){
								...
								while($rec = $db->db_fetch_array($query)){
									$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["MAN_BDG_ID"]."');\">".$img_edit." แก้ไข</a> ";
									$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["MAN_BDG_ID"]."');\">".$img_del." ลบ</a> ";
									?>
									<tr>
										<td align="center" bgcolor="#FFFFFF" ><?php echo $i+$goto; ?>.</td>
										<td bgcolor="#FFFFFF" align="left"><?php echo text($rec["MAN_BDG_NAME_TH"]); ?></td>
