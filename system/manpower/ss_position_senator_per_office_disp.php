...
if(!empty($S_LG_ID) && $S_LG_ID != 'undefined'){
	$filter .= " AND POSITION_FRAME.LG_ID = ".$S_LG_ID;
}
...
if(!empty($S_POS_NO) && $S_POS_NO != 'undefined'){
	$filter .= " AND POSITION_FRAME.POS_NO = ".$S_POS_NO;
}
...
$table=" POSITION_FRAME 
			...
			LEFT JOIN SETUP_POS_LINE_GROUP C ON POSITION_FRAME.LG_ID = C.LG_ID ";
...
$cond_lg = ($S_TYPE_ID != '') ? " AND TYPE_ID = '".$S_TYPE_ID."'" : "";
...
<script src="js/ss_position_senator_per_office_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
                     ...
                     <div class="col-xs-12 col-md-2" style="white-space:nowrap;">สายงาน :</div>
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-3">                                        
                          <select id="S_LINE_ID" name="S_LINE_ID" class="selectbox form-control" placeholder="-ทั้งหมด-" >
                              ...
                              $sql_line_name="SELECT LINE_ID , LINE_NAME_TH FROM SETUP_POS_LINE WHERE DELETE_FLAG='0' AND ACTIVE_STATUS = '1' AND POSTYPE_ID = '$POSTYPE_ID'".$cond_type." ORDER BY LINE_NAME_TH ASC";
						...
						<table class="table table-bordered table-striped table-hover">
							<thead>
								<tr class="bgHead">
                                    ...
                                    <th nowrap width="10%"><div align="center">ประเภทตำแหน่ง</div></th>
                                    <th nowrap width="10%"><div align="center">ระดับ</div></th>
                                    <th nowrap width="14%"><div align="center">สายงาน</div></th>
