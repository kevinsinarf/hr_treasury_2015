...
$filter = "";
if($s_name != ""){
	$filter .= " and (POSTYPE_NAME_TH like '%".ctext($s_name)."%' OR POSTYPE_NAME_EN like '%".ctext($s_name)."%') ";
}
if($s_status != ""){
	$filter .= " and ACTIVE_BY = '".ctext($s_status)."' ";
}

$field="POSTYPE_ID,POSTYPE_NAME_TH,POSTYPE_NAME_EN,ACTIVE_BY";
$table="SETUP_POSITION_TYPE ";
$pk_id="POSTYPE_ID";
$wh="1=1 and ACTIVE_BY='1' and DELETE_FLAG='0' {$filter} ";
$orderby="order by ACTIVE_BY desc, POSTYPE_ID desc";
  ...
  <div class="col-xs-12 col-sm-12">
    <div class="groupdata">
      <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <div class="row">
                <div class="col-xs-12 col-sm-2" style="white-space:nowrap;"><?php echo $arr_txt['type_pos'];?>บุคลากร :</div>
                        <div class="col-xs-12 col-sm-4">
                                  <input type="text" id="s_name" name="s_name" class="form-control" 
                                  placeholder="<?php echo $arr_txt['type_pos'];?>บุคลากร" value="<?php echo $s_name; ?>">
                        </div>
                <div class="col-xs-12 col-sm-1" style="white-space:nowrap;"><?php echo $arr_txt['active'];?> :</div>
            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="35%"><div align="center"><strong><span class="active"><?php echo $arr_txt['type_pos'];?>บุคลากร&nbsp;(<?php echo $arr_txt['th'];?>)</strong> </div></th>
                  <th width="35%"><div align="center"><strong><?php echo $arr_txt['type_pos'];?>บุคลากร&nbsp;(<?php echo $arr_txt['en'];?>)</strong> </div></th>
                  <th width="12%"><div align="center"><strong><?php echo $arr_txt['active'];?></strong></div></th>
                ...
                <?php
                                if($nums > 0){
                                    ...
                                    while($rec = $db->db_fetch_array($query)){
                                        ...
                                        $edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["POSTYPE_ID"]."');\">".$img_edit." แก้ไข</a> ";
                                        $delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["POSTYPE_ID"]."');\">".$img_del." ลบ</a> ";
                                ?>
                <tr bgcolor="#FFFFFF">
                  <td align="center"><?php echo $i+$goto; ?>.</td>
                  <td align="left"><?php echo text($rec["POSTYPE_NAME_TH"]); ?></td>
                  <td align="left"><?php echo text($rec["POSTYPE_NAME_EN"]); ?></td>
                  <td align="center"><?php echo ($arr_act_status[$rec["ACTIVE_BY"]]);?></td>
