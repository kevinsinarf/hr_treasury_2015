...
$filter .= " AND A.POSTYPE_ID = 17 AND A.ORG_ID_2 = 15 ";
...
<script src="js/ss_position_per_temporary_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-4 col-md-3">
						<select id="S_ORG_ID_3" name="S_ORG_ID_3" class="selectbox form-control" placeholder="-ทั้งหมด-">
							<option value=""></option>
							<?php
							$sql_org_3 = "Select ORG_ID , ORG_NAME_TH From SETUP_ORG WHERE ACTIVE_STATUS = 1 AND DELETE_FLAG = '0' AND OL_ID = 16 AND ORG_PARENT_ID = 15 ORDER BY ORG_SEQ ASC";
