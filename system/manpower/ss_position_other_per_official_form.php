...
if($proc == 'add'){
	$query_frame  = $db->query("SELECT MAX(CAST(POS_NO AS INT)) AS POS_NO_MAX FROM POSITION_FRAME WHERE POSTYPE_ID = 1 AND ORG_ID_2 = 17 ");
...
<script src="js/ss_position_other_per_official_form.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="ss_position_other_per_office_disp.php?<?php echo $paramlink; ?>"><?php echo showMenu($menu_sub_id)." (".$sub_menu.")"; ?></a></li>
			<li class="active"><?php echo $txt; ?></li>
		</ol>
	</div>
	<div class="col-xs-12 col-sm-12" id="content">
		<div class="groupdata" >
			<form id="frm-input" method="post" action="process/ss_position_other_per_official_process.php"enctype="multipart/form-data">
			  ...
			  <div class="row formSep">
					...
					<div class="col-xs-12 col-md-3" >
						<select id="LINE_ID" name="LINE_ID" class="selectbox form-control" placeholder="ตำแหน่งในสายงาน" >
							...
							if(!empty($data['LINE_ID'])){
								$sql_line_name = "Select LINE_ID , LINE_NAME_TH From SETUP_POS_LINE WHERE ACTIVE_STATUS = 1 AND DELETE_FLAG = '0' AND LG_ID = ".$data['LG_ID']." AND POSTYPE_ID = 1 ORDER BY LINE_NAME_TH ASC";
               ...
               <?php if($proc == 'edit'){ ?>
				...
				<div class="formlast">
					...
					<button type="button" class="btn btn-default" onClick="self.location.href='ss_position_other_per_office_disp.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id);?>';">ยกเลิก</button>
					</div>
				</div>
			</form>
		</div>
