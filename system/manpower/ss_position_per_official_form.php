...
if($proc == 'add'){
	$query_frame  = $db->query("SELECT MAX(CAST(POS_NO AS INT)) AS POS_NO_MAX FROM POSITION_FRAME WHERE POSTYPE_ID = 1 AND ORG_ID_2 = 15 ");
...
<script src="js/ss_position_per_official_form.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="ss_position_per_office_disp.php?<?php echo $paramlink; ?>"><?php echo showMenu($menu_sub_id); ?></a></li>
			<li class="active"><?php echo $txt; ?></li>
		</ol>
	</div>
	<div class="col-xs-12 col-sm-12" id="content">
		<div class="groupdata" >
			<form id="frm-input" method="post" action="process/ss_position_per_official_process.php"enctype="multipart/form-data">
			  ...
			  <div class="row formSep">
                ...
                <div class="row formSep">
					...
					<div class="col-xs-12 col-md-3">
						<?php echo GetHtmlSelect('MT_ID', 'MT_ID',$arr_type_manage , 'ประเภทตำแหน่งทางการบริหาร' ,$data['MT_ID'] ,'onChange="get_manage(this);"', '1', '', ''); ?>
					</div>
                    <div class="col-xs-12 col-md-2 col-md-offset-1" style="white-space:nowrap;">ตำแหน่งทางการบริหาร : </div>
					<div class="col-xs-12 col-md-3">
						<?php echo GetHtmlSelect('MANAGE_ID', 'MANAGE_ID',$arr_manage, 'ตำแหน่งทางการบริหาร' ,$data['MANAGE_ID'] ,'', '1', '', ''); ?>		
					</div>
			  </div>
              <div class="row formSep">
			...
			<div class="row formSep">
               ...
               <?php if($proc == 'edit'){ ?>
				...
				<div class="row formSep">
					<div class="col-xs-12 col-md-2" style="white-space:nowrap;">วันที่อนุมัติตำแหน่ง :</div>
					<div class="col-xs-12 col-md-2">
				...
				<div class="formlast">
					...
					<button type="button" class="btn btn-default" onClick="self.location.href='ss_position_per_office_disp.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id);?>';">ยกเลิก</button>
					</div>
				</div>
			</form>
		</div>
