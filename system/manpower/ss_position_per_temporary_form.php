...
if($proc == 'add'){
	$query_frame  = $db->query("SELECT MAX(CAST(POS_NO AS INT)) AS POS_NO_MAX FROM POSITION_FRAME WHERE POSTYPE_ID = 17 AND ORG_ID_2 = 15 ");
	...
	LEFT JOIN SETUP_POS_LEVEL B ON A.LEVEL_ID = B.LEVEL_ID
	 WHERE A.POS_ID = '".$data['POS_ID']."' AND A.POSTYPE_ID = 17 ";
...
//$array
$arr_level=GetSqlSelectArray("LEVEL_ID", "LEVEL_NAME_TH", "SETUP_POS_LEVEL", "ACTIVE_STATUS='1' AND POSTYPE_ID = 17 and DELETE_FLAG='0' AND TYPE_ID = '".$data['TYPE_ID']."' ", "LEVEL_SEQ");
...
<script src="js/ss_position_per_temporary_form.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li><a href="ss_position_per_temporary_disp.php?<?php echo $paramlink; ?>"><?php echo showMenu($menu_sub_id); ?></a></li>
			<li class="active"><?php echo $txt; ?></li>
		</ol>
	</div>
	<div class="col-xs-12 col-sm-12" id="content">
		<div class="groupdata" >
			<form id="frm-input" method="post" action="process/ss_position_per_temporary_process.php"enctype="multipart/form-data">
					...
					<div class="col-xs-12 col-md-3">
						<select id="LINE_ID" name="LINE_ID" class="selectbox form-control" placeholder="ตำแหน่งในสายงาน" >
							...
							<?php
								...
								$sql_line_name = "Select LINE_ID , LINE_NAME_TH From SETUP_POS_LINE WHERE ACTIVE_STATUS = 1  ORDER BY LINE_NAME_TH ASC";
