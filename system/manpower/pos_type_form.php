...
<script src="js/pos_type_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
    ...
    <div class="col-xs-12 col-sm-12">
        <ol class="breadcrumb">
          ...
          <li><a href="pos_type_disp.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id);?>"><?php echo Showmenu($menu_sub_id);?></a></li>
          <li class="active"><?php echo $txt;?></li>
        </ol>
    </div>
    <div class="col-xs-12 col-sm-12" id="content">
        <div class="groupdata" >
		<form id="frm-input" method="post" action="process/pos_type_process.php">
		...
		<div class="row formSep">
			<div class="col-xs-12 col-sm-2 " style="white-space:nowrap">ชื่อประเภทตำแหน่งภาษาไทย&nbsp;: <span style="color:red;">*</span>&nbsp;</div>
            ...
            <div class="col-xs-12 col-sm-2 " style="white-space:nowrap">ชื่อย่อประเภทตำแหน่งภาษาไทย : </div>
             <div class="col-xs-12 col-sm-2">
        ...
        <div class="row formSep">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap">ชื่อประเภทตำแหน่งภาษาอังกฤษ :</div>
			<div class="col-xs-12 col-sm-3">
            ...
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ชื่อย่อประเภทตำแหน่งภาษาอังกฤษ :</div>
			<div class="col-xs-12 col-sm-2">
        ...
        <div class="row formSep">
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ลำดับสำหรับการจัดเรียง : <span style="color:red;">*</span> </div>
        ...
        <div class="formlast">
			<div class="col-xs-12 col-sm-12" align="center">
			  ...
			  <button type="button" class="btn btn-default" onClick="self.location.href='pos_type_disp.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id);?>';">ยกเลิก</button></button>
			</div>
        </div>
      </form>
    </div>
