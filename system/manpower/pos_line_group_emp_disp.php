...
$filter = "";
if(trim($s_name_th) != "" ){
		$filter .= " and LG_NAME_TH like '%".ctext(trim($s_name_th))."%' ";
}
if(trim($s_name_en) != "" ){
		$filter .= " and LG_NAME_EN like '%".ctext(trim($s_name_en))."%' ";
}
...
$field="   LG_ID , LG_NAME_TH  ,LG_NAME_EN , TYPE_NAME_TH , a.ACTIVE_STATUS ";
$table=" SETUP_POS_LINE_GROUP  a
left JOIN SETUP_POS_TYPE c ON a.TYPE_ID = c.TYPE_ID";
$pk_id="LG_ID";
$wh=" a.DELETE_FLAG='0' AND a.POSTYPE_ID = '5' {$filter} ";
$orderby="order by TYPE_SEQ asc, a.LG_NAME_TH asc";
    ...
    <div class="groupdata">
      <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <select id="sSPT_ID" name="sSPT_ID" class="selectbox form-control" placeholder="--ทั้งหมด--" >
       	...
       	<div class="row">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ชื่อสายงานภาษาไทย :</div>
            <div class="col-xs-12 col-sm-3"><input type="text" id="s_name_th" name="s_name_th" class="form-control" placeholder="ชื่อสายงานภาษาไทย" value="<?php echo $s_name_th; ?>"></div>
            <div class="col-xs-12 col-sm-2"></div>    
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ชื่อสายงานภาษาอังกฤษ :</div>
            <div class="col-xs-12 col-sm-3"><input type="text" id="s_name_en" name="s_name_en" class="form-control" placeholder="ชื่อสายงานภาษาอังกฤษ" value="<?php echo $s_name_en; ?>"></div>
		</div>
				...
				<table width="776" class="table table-bordered table-striped table-hover">
				  <thead>
					<tr class="bgHead">
					  ...
					  <th width="15%"><div align="center"><strong>กลุ่มงาน</strong></div></th>
                      <th width="20%"><div align="center"><strong>ชื่อสายงานภาษาไทย</strong></div></th>
					  <th width="20%"><div align="center"><strong>ชื่อสายงานภาษาอังกฤษ</strong> </div></th>
				  ...
				  <tbody>
					...
					if($nums > 0){
						...
						while($rec = $db->db_fetch_array($query)){
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["LG_ID"]."');\">".$img_edit." แก้ไข</a> ";
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["LG_ID"]."');\">".$img_del." ลบ</a> ";
							?>
                            <tr bgcolor="#FFFFFF">
                              <td align="center"><?php echo $i+$goto; ?>.</td>
                              <td align="left"><?php echo text($rec["TYPE_NAME_TH"]); ?></td>
                              <td align="left"><?php echo  text($rec["LG_NAME_TH"]); ?></td>
                              <td align="left"><?php echo text($rec["LG_NAME_EN"]); ?></td>
