...
$pk_id="TYPE_ID";
$wh=" DELETE_FLAG='0' and POSTYPE_ID = '1' {$filter} ";
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
      <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ชื่อประเภทตำแหน่งภาษาไทย :</div>
				...
				<table class="table table-bordered table-striped table-hover table-condensed">
				  <thead>
					<tr class="bgHead">
					  ...
					  <th width="30%"><div align="center"><strong>ชื่อประเภทตำแหน่งภาษาไทย</strong> </div></th>
					  <th width="30%"><div align="center"><strong>ชื่อประเภทตำแหน่งภาษาอังกฤษ</strong> </div></th>
