...
$field=" a.COMSET_ID, a.COMSET_YEAR,a.COMSET_EXPECT,b.COMTITLE_NAME_TH,c.MANAGE_NAME_TH";
$table="COMPETENCY_SET a
INNER JOIN COMPETENCY_TITLE b ON a.COMTITLE_ID = b.COMTITLE_ID
INNER JOIN SETUP_POS_MANAGE c ON a.MANAGE_ID = c.MANAGE_ID";
$pk_id="a.COMSET_ID";
$wh="a.DELETE_FLAG='0' AND a.COMSET_TYPE = '3' {$filter}";
...
//หัวข้อสรรถนะ
$query_compet = $db->query("SELECT * FROM COMPETENCY_TITLE WHERE ACTIVE_STATUS = 1 AND COMTITLE_TYPE = 3");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container-full">
    ...
    <div class="col-xs-12 col-md-12">
        <ol class="breadcrumb">
          ...
          <li class="active">สมรรถนะในการบริหารประจำปี</li>
        </ol>
    </div>
        ...
        <div class="groupdata">
            ...
            <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ปีที่ใช้สมรรถนะ :</div>
                    ...
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ชื่อหัวข้อสมรรถนะในการบริหาร :</div>
                            ...
                            <table class="table table-bordered table-striped table-hover table-condensed">
                                <thead>
                                  <tr class="bgHead">   
                                       ...
                                       <th width="30%" ><div align="center">ชื่อหัวข้อสมรรถนะในการบริหาร</div></th>
                                   	   <th width="10%" ><div align="center"><strong>ค่าความคาดหวัง</strong></div></th>
                                       <th width="20%" ><div align="center"><strong>ตำแหน่งในการบริหาร</strong></div></th>
