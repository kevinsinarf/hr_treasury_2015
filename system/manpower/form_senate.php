...
$arr_command_type = GetSqlSelectArray("CT_ID", "CT_NAME_TH", "SETUP_COMMAND_TYPE", " CT_TYPE = '2' ", "CT_NAME_TH");
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="groupdata" >
                <form id="frm" method="post" action="process/process_senate.php">
                   ...
                   <div class="row formSep">
                    ...
                    <div class="row formSep">
                        <div class="col-xs-12 col-sm-2" >ลำดับหน่วยงาน : <span style="color:red;">*</span>&nbsp;</div>
                    ...
                    <div class="row formSep">
                    <div class="col-xs-12 col-sm-2" >ปีที่จัดโครงสร้าง : <span style="color:red;">*</span>&nbsp;</div>
                    ...
                    <!--<input name="org_year" class="form-control number" id="org_year" type="text" value="<?php echo $org_year; ?>">-->
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-3"><input name="org_name_th" class="form-control" id="org_name_th" type="text" value="<?php echo $org_name_th; ?>"></div>
                    <div class="col-xs-12 col-sm-1" ></div>
                    <div class="col-xs-12 col-sm-2" >ชื่อหน่วยงาน(ภาษาอังกฤษ) :</div>
                    <div class="col-xs-12 col-sm-3"><input name="org_name_en" class="form-control" id="org_name_en" type="text" value="<?php echo $org_name_en; ?>"></div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-3"><input name="org_shortname_en" class="form-control" id="org_shortname_en" type="text" value="<?php echo $org_shortname_en; ?>"></div>
                     ...
                     <div class="row formSep">
                      ...
                      <div class="col-xs-6 col-sm-2">
                                 <label><input name="active_status" type="radio" id="active_status1" value="1" <?php echo ($active_status == '1' || $active_status == '' ? "checked":""); ?>> <?php echo $arr_act_status['1'];?></label>&nbsp;&nbsp;
                                 <label><input name="active_status" type="radio" id="active_status2" value="2" <?php echo ($active_status == '2' ? "checked":""); ?>> <?php echo $arr_act_status['0'];?></label>	
                      </div>
                    </div>
