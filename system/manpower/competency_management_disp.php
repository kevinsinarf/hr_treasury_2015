...
$pk_id="COMTITLE_ID";
$wh="DELETE_FLAG='0' and COMTITLE_TYPE = '3' {$filter}";
...
<div class="container-full">
    ...
    <div class="col-xs-12 col-sm-12">
        <ol class="breadcrumb">
          ...
          <li class="active">ตั้งค่าสมรรถนะในการบริหาร</li>
        </ol>
    </div>
    <div class="col-xs-12 col-sm-12" id="content"> 
        ...
        <div class="grouptab">
            ...
            <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<div class="row">
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;"><?php echo $arr_competency_type['competency_management']; ?> :</div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name" name="s_name" class="form-control" placeholder="<?php echo $arr_competency_type['competency_management']; ?>" value="<?php echo $s_name; ?>"></div>
                            ...
                            <table class="table table-bordered table-striped table-hover table-condensed">
                                <thead>
                                    <tr class="bgHead">
                                        ...
                                        <th width="30%"><div align="center"><strong><?php echo $arr_competency_type['competency_management']; ?> (<?php echo $arr_txt['th'] ;?>)</strong></div></th>
                                        <th width="30%"><div align="center"><strong><?php echo $arr_competency_type['competency_management']; ?> (<?php echo $arr_txt['en'] ;?>)</strong></div></th>
