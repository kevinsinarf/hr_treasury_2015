...
if(!empty($S_POS_NO) && $S_POS_NO != 'undefined'){
	$filter .= " AND POSITION_FRAME.POS_NO = ".trim($S_POS_NO);
}
...
$orderby=" ORDER BY CAST(POSITION_FRAME.POS_NO AS INT) ASC";
...
<script src="js/ss_position_per_office_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
