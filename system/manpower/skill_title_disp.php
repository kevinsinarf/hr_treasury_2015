...
$table="SKILL_TITLE";
$pk_id="SKILLTITLE_ID";
$wh="DELETE_FLAG='0' AND SKILL_TYPE = 1 {$filter}";
  ...
  <div class="col-xs-12 col-sm-12" id="content">
   <?php include("tab_skill.php");?>
    <div class="grouptab">
		...
		<div class="row">
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อหัวข้อทักษะจำเป็นในงาน : </div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name" name="s_name" class="form-control" placeholder="หัวข้อทักษะจำเป็นในสายงาน" value="<?php echo $s_name; ?>"></div>
              ...
              <thead>
                <tr class="bgHead">
                  <th width="5%"><div align="center"><strong>ลำดับ</strong></div></th>
                     <th width="30%"><div align="center"><strong>ชื่อหัวข้อทักษะจำเป็นในงาน (<?php echo $arr_txt['th'] ;?>)</strong></div></th>
                     <th width="30%"><div align="center"><strong>ชื่อหัวข้อทักษะจำเป็นในงาน (<?php echo $arr_txt['en'] ;?>)</strong></div></th>
