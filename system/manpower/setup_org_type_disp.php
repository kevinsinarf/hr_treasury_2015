...
$filter = "";
if($s_name != ""){
	$filter .= " and (OT_NAME_TH like '%".ctext($s_name)."%' OR OT_NAME_EN like '%".ctext($s_name)."%') ";
}
if($s_status != ""){
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
		...
		<div class="row">
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อประเภทส่วนราชการ :</div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name" name="s_name" class="form-control" placeholder="ชื่อประเภทส่วนราชการ" value="<?php echo $s_name; ?>"></div>
			<div class="col-xs-12 col-md-2"></div>
            <div class="col-xs-12 col-md-2 " style="white-space:nowrap;"><?php echo $arr_txt['active'];?> :  </div>
              ...
              <thead>
                <tr class="bgHead">
                  <th width="10%"><div align="center"><strong>ลำดับ</strong></div></th>
                     <th width="30%"><div align="center"><strong>ชื่อประเภทส่วนราชการ (<?php echo $arr_txt['th'] ;?>)</strong></div></th>
                     <th width="30%"><div align="center"><strong>ชื่อประเภทส่วนราชการ (<?php echo $arr_txt['en'] ;?>)</strong></div></th>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
							...
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["OT_ID"]."');\">".$img_edit." แก้ไข</a> ";
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["OT_ID"]."');\">".$img_del." ลบ</a> ";
				?>
                <tr bgcolor="#FFFFFF">
                  <td align="center"><?php echo $i+$goto; ?>.</td>
                  <td align="left"><?php echo text($rec["OT_NAME_TH"]); ?></td>
                  <td align="left"><?php echo text($rec["OT_NAME_EN"]); ?></td>
