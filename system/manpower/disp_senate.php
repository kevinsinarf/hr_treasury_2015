...
with recursive_member as (
	...
	where ORG_ID = '16' AND a.DELETE_FLAG = '0'
...
//$arrList = array('17'=>'dd','16'=>'dd','15'=>'dd');
...
function recursive_list($arr,$seq,$db){
	...
	foreach($arr as $key => $arrVal){
		//$addSub = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"addData('".$key."');\"><span class=\"glyphicon glyphicon-plus\"></span> เพิ่ม</a> ";;
