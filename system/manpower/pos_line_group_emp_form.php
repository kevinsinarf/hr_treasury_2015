...
$SQL_POS_TYPE ="SELECT TYPE_ID, TYPE_NAME_TH FROM SETUP_POS_TYPE WHERE ACTIVE_STATUS = '1' AND POSTYPE_ID = '5' AND DELETE_FLAG = '0' ORDER BY TYPE_SEQ ASC ";
...
<script src="js/pos_line_group_emp_disp.js?<?php echo rand(); ?>"></script>
...
<div class="container-full">
    ...
    <div class="col-xs-12 col-sm-12" id="content">
        <div class="groupdata" >
		<form id="frm-input" method="post" action="process/pos_line_group_emp_process.php">
		...
		<div class="row formSep">
            <div class="col-xs-12 col-sm-2">กลุ่มงาน :&nbsp;<span style="color:red;">*</span>&nbsp;</div>
            <div class="col-xs-12 col-sm-3">
                <select id="TYPE_ID" name="TYPE_ID" class="selectbox form-control" placeholder="กลุ่มงาน" style="width:200px;">
                    <option value=""></option>
                    <?php
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-2"><!--onKeyUp="chkDup('chkDup1','flagDup1','LG_NAME_TH','LG_ID','SETUP_POS_LINE_GROUP','TYPE_ID='+$('#TYPE_ID').val());"-->
                <input id="LG_NAME_TH" type="text" name="LG_NAME_TH" class="form-control" maxlength="100" placeholder="ชื่อสายงานภาษาไทย" value="<?php echo  $LG_NAME_TH; ?>" >
            </div>
            <div class="col-xs-12 col-sm-2">
            <span id="chkDup1" class="hidden-xs label"></span>
            </div>
            <div class="col-md-2 col-sm-2">ชื่อย่อสายงานภาษาไทย :</div>
				<div class="col-md-2 col-sm-2"><!--onKeyUp="chkDup('chkDup4','flagDup4','LG_SHORTNAME_TH','LG_ID','SETUP_POS_LINE_GROUP','TYPE_ID='+$('#TYPE_ID').val());"-->
                  <span id="chkDup4" class="visible-xs label"></span>
					<input id="LG_SHORTNAME_TH" type="text" name="LG_SHORTNAME_TH" class="form-control" placeholder="ชื่อย่อระดับภาษาไทย" value="<?php echo  $LG_SHORTNAME_TH ; ?>" maxlength="10" >
				</div>
                <div class="col-xs-12 col-sm-2">
               <span id="chkDup4" class="hidden-xs label"></span>
               </div>
        </div>
            
        <div class="row formSep">      
            <div class="col-xs-12 col-sm-2">ชื่อสายงานภาษาอังกฤษ :</div>
            <div class="col-xs-12 col-sm-2"><!--onKeyUp="chkDup('chkDup2','flagDup2','LG_NAME_EN','LG_ID','SETUP_POS_LINE_GROUP','');"-->
            <input id="LG_NAME_EN" type="text" name="LG_NAME_EN" class="form-control" maxlength="100" placeholder="ชื่อสายงานภาษาอังกฤษ" value="<?php echo  $LG_NAME_EN ; ?>" >
            </div> 
            <div class="col-xs-12 col-sm-2">      
            <span id="chkDup2" class=" hidden-xs label"></span>
            </div>
            <div class="col-xs-12 col-sm-2">ชื่อย่อสายงานภาษาอังกฤษ :</div>
			 <div class="col-xs-12 col-sm-2"><!--onKeyUp="chkDup('chkDup5','flagDup5','LG_SHORTNAME_EN','LG_ID','SETUP_POS_LINE_GROUP','TYPE_ID='+$('#TYPE_ID').val());"-->
			   <input id="LG_SHORTNAME_EN" type="text" name="LG_SHORTNAME_EN" class="form-control" placeholder="ชื่อย่อสายงานภาษาอังกฤษ" value="<?php echo  $LG_SHORTNAME_EN ; ?>" maxlength="10" >
			</div>
            <div class="col-xs-12 col-sm-2">
            <span id="chkDup5" class=" hidden-xs label"></span>  
            </div> 
        </div>
		<div class="row formSep">
