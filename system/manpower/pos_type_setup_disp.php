...
$pk_id="TYPE_ID";
$wh="DELETE_FLAG='0' and POSTYPE_ID = '5' {$filter}";
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
    <div class="groupdata">
		...
		<div class="row">
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อกลุ่มงานภาษาไทย :</div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name_th" name="s_name_th" class="form-control" placeholder="ชื่อกลุ่มงานภาษาไทย" value="<?php echo $s_name_th; ?>"></div>
			<div class="col-xs-12 col-md-2"></div>
            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อกลุ่มงานภาษาอังกฤษ :</div>
			<div class="col-xs-12 col-md-3"><input type="text" id="s_name_en" name="s_name_en" class="form-control" placeholder="ชื่อกลุ่มงานภาษาอังกฤษ" value="<?php echo $s_name_en; ?>"></div>
        </div>
            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="30%"><div align="center"><strong>ชื่อกลุ่มงานภาษาไทย</strong></div></th>
                  <th width="30%"><div align="center"><strong>ชื่อกลุ่มงานภาษาอังกฤษ</strong></div></th>
