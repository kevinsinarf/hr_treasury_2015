...
<div class="container-full">
    ...
    <div class="col-xs-12 col-sm-12">
            <ol class="breadcrumb">
              ...
              <li><a href="disp_gov_within.php?<?php echo $paramlink; ?>">กรมป้องกันและบรรเทาสาธารณภัย</a></li>
              <li class="active"><?php echo $txt; ?></li>
            </ol>
    </div >
    <div class="col-xs-12 col-sm-12" id="content">
        <div class="groupdata">
            <form id="frm-input" method="post" action="process/process_gov_within.php">
               ...
               <div class="row head-form">หน่วยงาน</div>
                ...
                <div class="col-xs-12 col-sm-12" align="center">
                    ...
                    <button type="button" class="btn btn-default" onClick="self.location.href='disp_gov_within.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id);?>';">ยกเลิก</button>
                </div>
