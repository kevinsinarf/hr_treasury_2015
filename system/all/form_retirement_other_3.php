...
$field = " A.PER_ID, A.PER_IDCARD, A.PREFIX_ID, A.PER_FIRSTNAME_TH, A.PER_MIDNAME_TH, A.PER_LASTNAME_TH, B.TYPE_NAME_TH, C.LEVEL_NAME_TH, D.LINE_NAME_TH, E.ORG_NAME_TH AS ORG_NAME_3, G.ORG_NAME_TH AS ORG_NAME_4 ";
$table = "  PER_PROFILE A LEFT JOIN SETUP_POS_TYPE B ON A.TYPE_ID = B.TYPE_ID
