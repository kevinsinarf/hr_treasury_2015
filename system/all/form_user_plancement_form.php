...
$table="PER_PROFILE a";
$pk_id="a.PER_ID";
$wh=" ACTIVE_STATUS = 1 AND PT_ID = 1 AND PER_ID NOT IN(SELECT TRANS_REQ_PER_ID FROM TRANSFER_LIST) ".$ConName;
...
<button type="button" class="btn btn-primary" onClick="search_pop('form_user_plancement_form.php','show_display',$('#name_serch').val());">ค้นหา</button>
</div>
</div>
