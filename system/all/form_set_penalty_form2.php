...
<div class="row">
    ...
    <input type="text" id="name_serch2" name="name_serch2" class="form-control" placeholder="<?php echo $arr_txt['name'];?>" value="<?php echo $s_name_th;?>"  ></div>
</div>
<div class="row">
<div class="col-xs-12 col-md-10" align="center">
<button type="button" class="btn btn-primary" onClick="search_pop('form_set_penalty_form2.php','show_display2',$('#name_serch2').val());">ค้นหา</button>
</div>
</div>
	...
	<table class="table table-bordered table-striped table-hover table-condensed">
		...
		if($nums > 0){
			...
			while($rec = $db->db_fetch_array($exc)){
                ...
                <tr>
                    <td align="center">
                    <input type="radio" id="chk<?php echo $i;?>" name="chk" value="<?php echo $rec['PER_ID'];?>" onClick="return_name2('<?php echo $rec['PER_ID'];?>','<?php echo $name;?>','<?php echo $position;?>');"></td>
