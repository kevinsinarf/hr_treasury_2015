...
<div class="row">
	...
	<div class="col-xs-2 col-md-5"><a href="javascript:void(0);"><img src="<?php echo $path;?>images/tb_attach.png" onclick="document.location.href='<?php echo $path;?>include/getFileDownload.php?path=../fileupload/import_borough/ex_borough.xls'" title="ตัวอย่างไฟล์นำเข้า"></a>
	</div>
</div>
<div class="row">
