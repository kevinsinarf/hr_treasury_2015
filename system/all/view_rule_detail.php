...
<table align="center" class="table table-bordered table-striped table-hover table-condensed" id="tb_data">
    <thead>
        <tr class="bgHead">
            ...
            <th width="6%"><div align="center"><strong>ร้อยละ</strong></div></th>
            <th width="12%"><div align="center"><strong>ตั้งแต่วันที่</strong></div></th>
            <th width="12%"><div align="center"><strong>ถึงวันที่</strong></div></th>
        </tr>
    </thead>
    <tbody >
	<?php
    if($nums > 0){
        ...
        while($rec = $db->db_fetch_array($query)){
            ...
            <tr>
                ...
                <td><?php echo conv_date($rec['RESULT_EDATE'],'short');?></td>
            </tr>
            <?php
            $i++;
        }
