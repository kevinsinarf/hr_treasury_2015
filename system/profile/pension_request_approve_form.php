					...
					while($r_poshis = $db->db_fetch_array($q_poshis)){
                        ...
                        <tr bgcolor="#FFFFFF" <?php echo "id='poshis_row_".$i."'"; ?>>
                            ...
                            <td align="left"><?php 
								...
								echo "<div class='row' ><span id='' >".(GetHtmlSelect($id.$i,$id.$i,$arr,'ประเภทตำแหน่ง',$r_poshis['POSHIS_TYPE_ID'],'onchange="getPosLevel(this.value,\''.$POSTYPE_ID.'\',\''.$i.'\');getPosLine(this.value,\''.$POSTYPE_ID.'\',\''.$i.'\');getPosManage(this.value,\''.$POSTYPE_ID.'\',\''.$i.'\');"','','1'))."</span></div>";
