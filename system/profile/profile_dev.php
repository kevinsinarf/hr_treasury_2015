              ...
              <table class="table table-bordered table-striped table-hover">
				...
				if($nums1 > 0){
					...
					while($rec = $db->db_fetch_array($query1)){
						$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["TRAINHIS_ID"]."');\">".$img_view." ดูรายละเอียด</a> ";
