...
$headline_title = " จำนวนตำแหน่งจำแนกตามประเภทตำแหน่ง                        ";
$menu_name = 36;
   ...
   $arr_org = array();
   $sql_org = "select TYPE_ID, TYPE_NAME_TH ";
   $sql_org .= " from SETUP_POS_TYPE  "; 
...
<div id="content" class="container-full">
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000; width:25%;  '   rowspan='2'><div align='center'><strong>ประเภทตำแหน่ง </strong></div></th>
