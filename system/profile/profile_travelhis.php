...
$field="a.TRAV_ID, a.PER_ID, a.TRAV_SEQ, b.COUNTRY_NAME_TH, a.TRAV_SDATE, a.TRAV_EDATE, a.ACTIVE_STATUS";
$table=" PER_TRAVELHIS  a LEFT JOIN SETUP_COUNTRY b ON a.COUNTRY_ID = b.COUNTRY_ID ";
$pk_id="a.TRAV_ID";
$wh=" a.PER_ID = '".$PER_ID."' AND a.DELETE_FLAG = '0' {$filter} ";
$orderby="order by a.ACTIVE_STATUS DESC, TRAV_SEQ ASC ";
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12">
    <ol class="breadcrumb">
      ...
      <li class="active">ประวัติการเดินทางไปต่างประเทศ</li>
    </ol>
  </div>
  <div class="col-xs-12 col-sm-12" id="content">
    ...
    <div class="grouptab">
      ...
      <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		...
		<input type="hidden" id="TRAV_ID" name="TRAV_ID" value="">
              ...
              <table class="table table-bordered table-striped table-hover table-condensed">
                <thead>
                  <tr class="bgHead">
                    ...
                    <th width="16%"><div align="center"><strong>ประเทศ</strong></div></th>
                    <th width="12%"><div align="center"><strong>วันที่ไป</strong></div></th>
                    <th width="12%"><div align="center"><strong>วันที่กลับ</strong></div></th>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["TRAV_ID"]."');\">".$img_edit." แก้ไข</a> ";
						$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["TRAV_ID"]."');\">".$img_del." ลบ</a> ";
						?>
						<tr bgcolor="#FFFFFF">
                            <td align="center"><?php echo $i+$goto; ?>.</td>
                            <td align="center"><?php echo text($rec["TRAV_SEQ"]); ?></td>
                            <td align="left"><?php echo text($rec["COUNTRY_NAME_TH"]); ?></td>
                            <td align="center"><?php echo conv_date($rec["TRAV_SDATE"],'short'); ?></td>
                            <td align="center"><?php echo conv_date($rec["TRAV_EDATE"],'short'); ?></td>
