...
$headline_title = "รายงานจำนวนข้าราชการจำแกตามช่วงอายุ โครงสร้างอายุข้าราชการ";
$menu_name = 6;
...
<div id="content" class="container-full">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                    <select id="AGE_BETWEEN" name="AGE_BETWEEN" class="selectbox form-control" placeholder="ค้นหาตามช่วงอายุ "     >   
                      			<option value=""></option>
                               <option value="1"   >ช่วงอายุระหว่าง &lt;20 ปี</option>
                               <option value="2"   >ช่วงอายุระหว่าง 21-30 ปี</option>  
                               <option value="3"   >ช่วงอายุระหว่าง 31-40 ปี</option>
                               <option value="4"   >ช่วงอายุระหว่าง 41-50 ปี</option>                                              
                     		   <option value="5"   >ช่วงอายุระหว่าง 51-60 ปี</option>   
                     		   <option value="6"   >ช่วงอายุ  &gt;60 ปี</option>                                           
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000;  ' rowspan=2><div align='center'><strong>อายุ</strong></div>&nbsp;</th>
