...
//ประเภทการเคลื่อนไหว
$arr_mov_type = GetSqlSelectArray("MOVEMENT_ID", "MOVEMENT_NAME_TH", "SETUP_MOVEMENT", "ACTIVE_STATUS='1' and DELETE_FLAG='0' AND MOVEMENT_TYPE = '1'  ", "MOVEMENT_NAME_TH");


$field = " A.ORG_ID_1,A.ORG_ID_2,A.ORG_ID_3,A.ORG_ID_4,A.ORG_ID_5,B.CT_ID, B.CT_NAME_TH, C.MOVEMENT_NAME_TH ,A.MOVEMENT_ID,A.COM_NO ,A.COM_DATE ,A.SALHIS_DATE, A.COM_SDATE ,A.SALHIS_ID,A.TYPE_LIVE,A.ACTIVE_STATUS,A.SALHIS_NOTE,A.POS_NO,D.ORG_NAME_TH,E.LG_NAME_TH,F.LINE_NAME_TH,G.MT_NAME_TH,H.MANAGE_NAME_TH ,A.SALARY ,A.SALARY_POSITION, A.COMPENSATION_1 ,A.COMPENSATION_2, A.COMPENSATION_3,A.COMPENSATION_5 ,A.TYPE_ID,A.SALHIS_TYPE,A.LG_ID,A.LINE_ID,A.MT_ID,A.MANAGE_ID,A.POS_NO,A.SALHIS_UP,A.SALHIS_UP,A.LEVEL_ID,A.POS_YEAR";
               	...
               	if($nums > 0){
                    ...
                    while($rec = $db->db_fetch_array($query)){
                        if($rec['POSHIS_DEFAULT']!="1"){
                            $edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["SALHIS_ID"]."');\">".$img_view." ดูรายละเอียด</a> ";
