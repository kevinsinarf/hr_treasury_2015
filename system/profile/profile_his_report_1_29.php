...
$headline_title = "  รายงานสรุปข้อมูลราชการส่งสำนักงาน ก.พ.                  ";
$menu_name = 29;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ระบุุปี :</div>
			<div class="col-xs-12 col-sm-3">
                    <select id="AGE_IS" name="AGE_IS" class="selectbox form-control" placeholder="ปี "     >   
                      <option value=""></option>
 ...
 <?php
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ระดับส่วน/กลุ่มงาน </strong></div></th>
	
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>วันที่บรรจุ </strong></div></th>
	
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>สถานะของบุคคล </strong></div></th>
  </tr>
