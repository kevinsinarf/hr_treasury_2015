...
<ul class="nav nav-tabs visible-md visible-lg" >
	...
	<li class="dropdown <?php echo $tab3;?>">
		...
		<ul class="dropdown-menu">
			<li><a href="profile_positionhis.php?<?php echo url2code($link."&ACT=3");?>"><?php echo $arr_txt['profile_history']; ?></a></li>
			...
			<li><a href="profile_servicehis.php?<?php echo url2code($link."&ACT=3");?>">ประวัติการปฏิบัติราชการพิเศษ</a></li>
