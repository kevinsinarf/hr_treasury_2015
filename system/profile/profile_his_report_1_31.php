...
$headline_title = "  รายงานสรุปข้อมูลอัตรากำลังข้าราชการตามประเภท และตำแหน่ง                    ";
$menu_name = 31;
...
<?php  echo GetHtmlSelect3('CV_ID','CV_ID',$arr_org6,"ประเภทข้าราชการ"." (".$arr_txt['th'].")","",'','','1');  ?>                 
            </div>
            <div class="col-xs-12 col-sm-1"></div>
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;"> 	ประเภทตำแหน่ง  :		<div class="col-xs-12 col-sm-2">  </div></div>
			<div class="col-xs-12 col-sm-2">
<?php  echo GetHtmlSelect3('TYPE_ID','TYPE_ID',$arr_org5,"ประเภทตำแหน่ง "." (".$arr_txt['th'].")","",'','','1');  ?> 
			</div>
 ...
 <div class="row"  style="text-align:center;"><button type="button" class="btn btn-primary" onClick="searchData();">ค้นหา</button></div>
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000; width:15%;  '  ><div align='center'><strong>".$arr_txt['idcard']." </strong></div></th>
 
    <th style=' border:solid 1px #000000; width:35%;  '   '  ><div align='center'><strong>ชื่อ-สกุล </strong></div></th>

    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>เลขที่ตำแหน่ง </strong></div></th>
	
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ระดับตำแหน่ง  </strong></div></th>
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ตำแหน่งในสายงาน  </strong></div></th>	
     <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ตำแหน่งทางการบริหาร   </strong></div></th>	
  </tr>
