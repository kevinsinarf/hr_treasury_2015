...
$headline_title = "จำนวนข้าราชการที่บรรจุในปีงบประมาณ ";
$menu_name = 10;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ระบุปีงบประมาณ :</div>
			...
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;"> 			<div class="col-xs-12 col-sm-2">
               <?php echo btn_do_center("searchData();","a"); ?>
          </div></div>
