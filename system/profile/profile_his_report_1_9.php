...
$headline_title = "รายงานจำนวนข้าราชการจำแนกตามวุฒิการศึกษา / สาขาวิชาเอก";
$menu_name = 9;
   ...
   $sql_line = "select ED_ID, ED_NAME_TH ";
   $sql_line .= " from SETUP_EDU_DEGREE  "; 
 
    $sql_line .= " ORDER BY ED_NAME_TH ASC";
	$query_line = $db->query($sql_line); 
    //echo $sql_line; exit();

   $sql_level = "select EM_ID, EM_NAME_TH+''+EM_NAME_EN as UNAME ";
   $sql_level .= " from SETUP_EDU_MAJOR  "; 
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                    <select id="LINE_ID" name="LINE_ID" class="selectbox form-control" placeholder="วุฒิการศึกษา "     >   
                      <option value=""></option>
                      <?php while($rec1 = $db->db_fetch_array($query_line)){?>
                        <option value="<?php echo $rec1['ED_ID']?>"   >
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                    <select id="LEVEL_ID" name="LEVEL_ID" class="selectbox form-control" placeholder="สาขาวิชาเอก "     >   
                      <option value=""></option>
                      <?php while($rec2 = $db->db_fetch_array($query_level)){?>
                        <option value="<?php echo $rec2['EM_ID']?>"   >
                        <?php echo text($rec2['UNAME'])?></option>
                      <?php }?>
                    </select>			
            </div>
            <div class="col-xs-12 col-sm-1"></div>
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">  			<div class="col-xs-12 col-sm-2"><button type="button" class="btn btn-primary" onClick="searchData2();">ค้นหา</button></div></div>
			<div class="col-xs-12 col-sm-2">
  ...
  <tr  class='bgHead'>
    ...
    <th style=' border:solid 1px #000000;  ' rowspan=2><div align='center'><strong>วุฒิการศึกษา / สาขาวิชาเอก</strong></div>&nbsp;</th>
