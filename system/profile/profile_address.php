                        ...
                        <table class="table table-bordered table-striped table-hover table-condensed">
                            ...
                            if($nums > 0){
                                ...
                                while($rec = $db->db_fetch_array($query)){
                                    ...
                                    $edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["PADD_ID"]."');\">".$img_view." ดูรายละเอียด</a> ";
