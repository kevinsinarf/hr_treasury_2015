...
$headline_title = "  รายงานกรอบอัตรากำลังข้าราชการจำแนกตามสายงาน ระดับตำแหน่ง คนครอง และ อัตราว่าง     ";
$menu_name = 28;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                    <select id="LINE_ID" name="LINE_ID" class="selectbox form-control" placeholder="สายงาน "     >   
                      <option value=""></option>
			...
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;"> 	ระดับตำแหน่ง :		<div class="col-xs-12 col-sm-2">  </div></div>
			<div class="col-xs-12 col-sm-2">
                    <select id="LINE_ID" name="LINE_ID" class="selectbox form-control" placeholder="ระดับตำแหน่ง "     >   
                      <option value=""></option>
                      <?php while($rec1 = $db->db_fetch_array($query_level)){?>
                        <option value="<?php echo $rec1['LEVEL_ID']?>"   >
                        <?php echo text($rec1['LEVEL_NAME_TH'])?></option>
                      <?php }?>
                    </select>		 
			</div>
        </div> 
 ...
 <div class="row"  style="text-align:center;"><button type="button" class="btn btn-primary" onClick="searchData();">ค้นหา</button></div>
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000; width:35%;  '  ><div align='center'><strong>สายงาน</strong></div></th>
 
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ระดับตำแหน่ง </strong></div></th>

    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>รายชื่อคนครอง </strong></div></th>
  </tr>
