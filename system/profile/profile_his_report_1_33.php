...
$headline_title = "  จำนวนตำแหน่งจำแนกตามสถานภาพและลักษณะของตำแหน่ง                     ";
$menu_name = 33;
 
 
 
 //org5
$arr_org5=GetSqlSelectArray("a.TYPE_ID", "a.TYPE_NAME_TH", "SETUP_POS_TYPE as a", "a.ACTIVE_STATUS='1' AND a.DELETE_FLAG='0' ", "TYPE_NAME_TH");
//org5
$arr_org6=GetSqlSelectArray("a.CV_ID", "a.CV_NAME_TH", "ANNOUNCE_SETUP_CIVIL_TYPE as a", "a.ACTIVE_STATUS='1' AND a.DELETE_FLAG='0' ", "CV_NAME_TH");
   ...
   $arr_org = array();
   $sql_org = "select LINE_ID, LINE_NAME_TH ";
   $sql_org .= " from SETUP_POS_LINE  "; 
   
   $sql_org .= " WHERE ACTIVE_STATUS = 1 "; 
...
<?php
  ...
  <tr class='bgHead'>
    <th style=' border:solid 1px #000000; width:10%; '  rowspan='2'><div align='center'><strong>ลำดับที่</strong></div></th>
    <th style=' border:solid 1px #000000; width:15%;  '   rowspan='2'><div align='center'><strong>ตำแหน่ง </strong></div></th>
 
 

    <th style=' border:solid 1px #000000;  ' colspan=4  ><div align='center'><strong>ลุักษณะของตำแหน่ง</strong></div></th>
      <th style=' border:solid 1px #000000; width:10%; '  rowspan='2'><div align='center'><strong>รวม</strong></div></th>
      <th style=' border:solid 1px #000000; width:10%; '  rowspan='2'><div align='center'><strong>หมายเหตุ</strong></div></th>
  </tr>
   <tr class='bgHead'>
    <th style='border-right:solid 1px #000000;' ><div align='center'><strong>ว่าง ไม่มีเงิน</strong></div></th>
    <th style='border-right:solid 1px #000000;' ><div align='center'><strong>ว่าง มีเงิน</strong></div></th>
    <th style='border-right:solid 1px #000000;' ><div align='center'><strong>มีคนถือครอง</strong></div></th>
    <th style='border-right:solid 1px #000000;' ><div align='center'><strong>ยุบเลิก</strong></div></th>
  </tr>
