...
<div class="groupdata" > <br>
	<?php include ("tab_info.php"); ?>
		...
		<div class="row formSep">
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;">ช่วงเวลาทวีคูณ :&nbsp;&nbsp;</div>
            <div class="col-xs-12 col-md-3"><?php  echo GetHtmlSelect_v('MULTIME_ID','MULTIME_ID',$arr_multitime,'เวลาทวีคุณ',$rec['MULTIME_ID'],'','','1');?>				</div>
			<div class="col-xs-12 col-md-2" style="white-space:nowrap;">จำนวนวันปฏิบัติราชการเวลาทวีคูณ :&nbsp;&nbsp;</div>
		</div>
        
        <div class="row formSep">
        	<div class="col-xs-12 col-md-2" style="white-space:nowrap;">จำนวนวันลา ขาด หนี <br>การปฏิบัติราชการในเวลาทวีคูณ :&nbsp;</div>
            <div class="col-xs-12 col-md-2"> <?php echo text($rec['MULTI_FRAC']); ?></div>
            <div class="col-xs-12 col-sm-2"></div>
            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">จำนวนวันคงเหลือ :&nbsp;</div>
            <div class="col-xs-12 col-md-2"><?php echo text($rec['MULTI_BALANCE']); ?></div>
     	</div> 
        
        <div class="row formSep">
            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">หมายเหตุ  : &nbsp;</div>
            <div class="col-xs-12 col-md-3"><?php echo text($rec['MULTI_NOTE']); ?></div>
        </div>
		...
		<div class="row head-form">
					...
					<div class="row formSep">
						...
						<div class="col-xs-12 col-md-2"><?php echo text($rec['POS_NO']); ?></div>
						<div class="col-xs-12 col-sm-2"></div>
					...
					<div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-3">
                                ...
                                while($org = $db->db_fetch_array($query_org_4)){
								   if($rec['ORG_ID_4']==$org['ORG_ID']){   echo text($org['ORG_NAME_TH']);  }
                    ...
                    <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-3"><?php  echo GetHtmlSelect_v('MT_ID','MT_ID',$arr_manage_type,'ประเภทตำแหน่งทางการบริหาร',$rec['MT_ID'],'onchange=get_manage(this);','','1');?></div>
