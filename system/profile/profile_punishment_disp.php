				...
				<table class="table table-bordered table-striped table-hover table-condensed">
					...
					if($nums > 0){
						...
						while($rec_main = $db->db_fetch_array($query_pen)){
                            ...
                            $edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec_main["PUN_ID"]."');\">".$img_view." ดูข้อมูล</a> ";
