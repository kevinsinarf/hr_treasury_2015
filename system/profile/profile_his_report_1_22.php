...
$headline_title = "รายงานรายชื่อข้าราชการที่ดำรงตำแหน่งในระดับ เรียงตามลำดับอาวุโส พร้อมทั้งแสดงระยะเวลาในการดำรงตำแหน่ง    ";
$menu_name = 22;
...
<div id="content" class="container-full">
 ...
 <div class="row"  style="text-align:center;"><button type="button" class="btn btn-primary" onClick="searchData();">ค้นหา</button></div>
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ตำแหน่ง - ระดับ</strong></div></th>
    <th style=' border:solid 1px #000000; width:35%;  '  ><div align='center'><strong>รายชื่อ</strong></div></th>
    <th style=' border:solid 1px #000000; width:20% '  ><div align='center'><strong>ระยะเวลาในการดำรงตำแหน่ง</strong></div></th>
