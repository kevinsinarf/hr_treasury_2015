...
$headline_title = "  รายชื่อข้าราชการที่ย้ายระหว่างกอง / สายงานในปีงบประมาณ      ";
$menu_name = 19;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">รูปแบบการย้าย :</div>
			<div class="col-xs-12 col-sm-3">
                  <select id="out_for_is" name="out_for_is" class="selectbox form-control"   placeholder="เลือกรูปแบบการย้าย" >  
                      <option value=""></option>
                  
                        <option value="1"   >ย้ายออกระหว่างกอง</option>
                        <option value="2"   >ย้ายออกระหว่างสายงาน</option>    
                                                              
                    </select>	
            </div>
            <div class="col-xs-12 col-sm-1"></div>
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;"> 	<button type="button" class="btn btn-primary" onClick="searchData();">ค้นหา</button>	<div class="col-xs-12 col-sm-2">  </div></div>
			<div class="col-xs-12 col-sm-2">
  ...
  <tr class='bgHead'>
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ลำดับที่</strong></div></th>
    <th style=' border:solid 1px #000000;  ' ><div align='center'><strong>ปีงบประมาณ - วัน เดือน ปี</strong></div>&nbsp;</th>
    <th style=' border:solid 1px #000000; width:50%;  ' ><div align='center'><strong>รายชื่อ</strong></div></th>
