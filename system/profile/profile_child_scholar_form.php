    ...
    <form id="frm-input" method="post" action="process/profile_child_scholar_process.php" enctype="multipart/form-data">
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-3">
                <?php  echo GetHtmlSelect('TYPE_ID','TYPE_ID',$arr_pos_type,'ประเภทตำแหน่ง',$rec['TYPE_ID'],'onchange="getPosLevel(this.value,\''.$POSTYPE_ID.'\');getPosLine(this.value,\''.$POSTYPE_ID.'\');getPosManage(this.value,\''.$POSTYPE_ID.'\');"','','1');?>
            </div> 
