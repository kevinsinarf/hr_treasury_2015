...
$headline_title = "  รายชื่อข้าราชการที่โอน ลาออก เสียชีวิต ในแต่ละปีงบประมาณ     ";
$menu_name = 17;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                  <select id="out_for_is" name="out_for_is" class="selectbox form-control"   placeholder="สาเหตุการออก" >  
                      <option value=""></option>
