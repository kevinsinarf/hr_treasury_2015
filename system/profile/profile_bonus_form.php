...
//org2
$arr_org2=GetSqlSelectArray("a.ORG_ID", "a.ORG_NAME_TH", "SETUP_ORG as a ", " a.ACTIVE_STATUS='1' AND a.DELETE_FLAG='0' AND a.ORG_PARENT_ID='".$org_id_1."' ", "ORG_SEQ");
//org3
...
<div class="groupdata" > <br>
	<?php include ("tab_info.php"); ?>
     <div class="clearfix"></div>
        ...
        <div class="row formSep">
        	<div class="col-xs-12 col-sm-2" style="white-space:nowrap">ประเภท : <span style="color:red;"></span></div>
            <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect_v('CT_ID','CT_ID',$arr_ct_type1,'ประเภทคำสั่ง',$rec['CT_ID'],'','','1');?></div> 
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-md-2">				
                <div class="input-group">
                     <?php echo $rec["BOUNUSHIS_DATE"]==''?'':conv_date(text($rec["BOUNUSHIS_DATE"]),''); ?>
            ...
            <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect_v('TYPE_LIVE','TYPE_LIVE',$arr_poshis_live,'ประเภทการถือครอง',$rec['TYPE_LIVE'],'','','1','','2');?></div><div class="col-xs-12 col-sm-1"></div>
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">สถานะของการบันทึก :&nbsp;<span style="color:red;"></span>&nbsp;</div>
                 ...
                 <div class="row formSep">
                 		<div class="col-xs-12 col-sm-2" style="white-space:nowrap">หมายเหตุ :</div>
                                <div class="col-xs-12 col-sm-8"><?php echo  text(trim($rec["BOUNUSHIS_NOTE"]));?></div> 		
                 </div>
				</div>
                 <div class="row head-form">
                            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">
       ...
       <?php if($POSTYPE_ID==3){?>
        ...
        <div class="row formSep">
            <div class="col-xs-12 col-md-2" style="white-space:nowrap">กลุ่มงาน/ส่วน :  </div>
            <div class="col-xs-12 col-md-3"><span id="x"><?php  echo GetHtmlSelect_v('ORG_ID_4','ORG_ID_4',$arr_org4,'ระดับส่วน/กลุ่มงาน ',$rec['ORG_ID_4'],'onchange="getORG(this);" ','','1');?></span></div>
            <div class="col-xs-12 col-md-1"></div> 
              <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ฝ่าย  :  </div>
            <div class="col-xs-12 col-md-3"><span id='ss_org5_1'>
                <?php  echo GetHtmlSelect_v('ORG_ID_5','ORG_ID_5',$arr_org5,'ฝ่าย ',$rec['ORG_ID_5'],'','','1');?></span>
      ...
      <?PHP if($PT_ID==3){ ?>
        ...
        <div class="row formSep">
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">กรม :</div>
            <div class="col-xs-12 col-sm-3"><span id='ss_org2'><?php  echo GetHtmlSelect_v('ORG_ID_2','ORG_ID_2',$arr_org2,'ระดับกรม',$rec['ORG_ID_2'],'onchange="getORG(this);"','','1'); ?></span></div> 
             <div class="col-xs-12 col-md-1"></div>
            <div class="col-xs-12 col-md-2" style="white-space:nowrap">กอง/สำนัก/กลุ่ม :  </div>
        ...
        <div class="row formSep">
            <div class="col-xs-12 col-md-2" style="white-space:nowrap">กลุ่มงาน/ส่วน :  </div>
            <div class="col-xs-12 col-md-3"><span id="ss_org_4"><?php  echo GetHtmlSelect_v('ORG_ID_4','ORG_ID_4',$arr_org4,'ระดับส่วน/กลุ่มงาน ',$rec['ORG_ID_4'],'onchange="getORG(this);"','','1');?></span></div>
            <div class="col-xs-12 col-md-1"></div> 
              <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ฝ่าย  :  </div>
            <div class="col-xs-12 col-md-3"><span id='ss_org5_1'>
                <?php  echo GetHtmlSelect_v('ORG_ID_5','ORG_ID_5',$arr_org5,'ฝ่าย ',$rec['ORG_ID_5'],'','','1');?></span>
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect_v('TYPE_ID','TYPE_ID',$arr_pos_type,'กลุ่ม',$rec['TYPE_ID'],'onChange="getLineGroup(this.value,\''.$POSTYPE_ID.'\');getlevel(this.value,\''.$POSTYPE_ID.'\');"','','1');?></div> 
               <div class="col-xs-12 col-sm-1"></div>
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">สายงาน : </div>
         <div class="col-xs-12 col-sm-3">
		 	<?php echo GetHtmlSelect_v('LG_ID','LG_ID',$arr_pos_lg,'สายงาน',$rec['LG_ID'],'onChange="GetLineGov(this.value,\''.$POSTYPE_ID.'\');"','','1');?>
         </div>
        </div>
		<div class="row formSep">
             <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ตำแหน่งในสายงาน : </div>
    ...
    <!-- //-------------------------------------------------------------- -->
            ...
            <div class="col-xs-12 col-md-2"><?php echo number_format($rec['COMPENSATION_5'],2); ?></div>
                    </div>
        		</div>
                   </div>
