...
$headline_title = "รายงานจำนวนข้าราชการ ที่ครบกำหนดอายุเกษียณราชการในแต่ละปี และในช่วง 5 ปี ";
$menu_name = 20;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ในช่วง 5 ปี :</div>
			<div class="col-xs-12 col-sm-3">
                    <select id="AGESET_IS" name="AGESET_IS" class="selectbox form-control" placeholder="ครั้งละ 5 ปี "     >   
                      <option value=""></option>
                      <?php for($i=2557;$i>2540;$i--){     $Y_five = $i-5;?>
                        <option value="<?php echo $i;?>"   >
                        <?php echo $i;?>  - <?php echo $Y_five; ?></option>
                      <?php }?>
                    </select>				
            </div>
            <div class="col-xs-12 col-sm-1"></div>
