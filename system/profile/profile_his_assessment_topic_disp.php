...
//คำนำหน้าชื่อ th
$arr_prefix=GetSqlSelectArray("PREFIX_ID", "PREFIX_NAME_TH", "V_PREFIX", "ACTIVE_STATUS='1' and DELETE_FLAG='0'", "PREFIX_SEQ,PREFIX_NAME_TH"); 
?>
<!DOCTYPE html>
<html>
<head>
...
<script src="js/profile_his_assessment_disp.js?<?php echo rand(); ?>"></script>
</head>
              ...
              <thead>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["PER_ID"]."');\">".$img_edit." แก้ไข</a> ";
