...
$field=" A.APPOINT_NO, B.APP_ID, C.CAN_IDCARD, C.PREFIX_ID, C.CAN_FIRSTNAME_TH, C.CAN_MIDNAME_TH, C.CAN_LASTNAME_TH, E.LINE_NAME_TH, G.ORG_NAME_TH, H.LEVEL_NAME_TH,C.FILE_PIC ";
...
$wh=" A.DELETE_FLAG='0' AND A.APPOINT_TYPE_PERSON = 2 AND TRANSFER_STATUS = 0 {$filter}";
...
//org3
$arr_org3=GetSqlSelectArray("a.ORG_ID", "a.ORG_NAME_TH", "SETUP_ORG as a", "a.ACTIVE_STATUS='1' AND a.DELETE_FLAG='0' AND a.ORG_PARENT_ID='15'  ", "ORG_SEQ");
//org4
...
<script src="js/profile_his_new_gov_emp_disp.js?<?php echo rand(); ?>"></script>
</head>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						...
						<tr bgcolor="#FFFFFF">
                          ...
                          <td align="center"><?php echo text($rec["APPOINT_NO"]);?><input type="text" id="FILE_PIC_NEW_<?php echo $rec['APP_ID'];?>" name="FILE_PIC_NEW[]"   value="<?php echo !empty($rec["FILE_PIC"])?text($rec["FILE_PIC"]):""; ?>"></td>
