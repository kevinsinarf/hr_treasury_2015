...
$headline_title = "รายงานจำนวนข้าราชการจำแนกตามระดับการศึกษา มหาวิทยาลัยและ ประเทศที่สำเร็จการศึกษา";
$menu_name = 5;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                    <select id="LINE_ID" name="LINE_ID" class="selectbox form-control" placeholder="ระดับการศึกษา "     >   
                      <option value=""></option>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                    <select id="LEVEL_ID" name="LEVEL_ID" class="selectbox form-control" placeholder="มหาวิทยาลัย "     >   
                      <option value=""></option>
		...
		<div class="row">
            ...
            <div class="col-xs-12 col-sm-1"></div>
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;"> 			<div class="col-xs-12 col-sm-2"><button type="button" class="btn btn-primary" onClick="searchData3();">ค้นหา</button></div></div>
			<div class="col-xs-12 col-sm-2">
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000;  ' rowspan=2><div align='center'><strong>ระดับการศึกษา / มหาวิทยาลัย / ประเทศที่สำเร็จการศึกษา</strong></div>&nbsp;</th>
