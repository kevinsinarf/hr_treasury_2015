...
$headline_title = "รายการกรอบอัตรากำลังและจำนวนผู้ปฎิบัติงานอยู่จริงในภาพรวมของข้าราชการกรมป้องกันและบรรเทาสาธารณภัย";
?><!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;">ชื่อหน่วยงาน :</div>
			<div class="col-xs-12 col-sm-3"><input type="text" id="s_ORG_NAME_TH" name="s_ORG_NAME_TH" class="form-control " placeholder="ชื่อหน่วยงาน" value=""></div>
			...
			<div class="col-xs-12 col-sm-2">
			  <select id="s_OT_ID" name="s_OT_ID" class="selectbox form-control" placeholder="--<?php echo $arr_txt['show_all']; ?>--">
                    ...
                    <option value="6"  >ส่วนภูมิภาค</option>	 
			  </select>
			</div>
        </div>
...
<div class="row"  style="text-align:center;"><button type="button" class="btn btn-primary" onClick="searchData();">ค้นหา</button></div>
 ...
 <?php
   ...
   $sql_org .= " ORDER BY ORG_SEQ ASC";
	...
	<tr class='bgHead' style='height:1cm;'>
          <th style=' border:solid 1px #000000; width:2cm;' ><div align='center'><strong>ลำดับที่</strong></div></th>
          <th style='border:solid 1px #000000; width:9cm;' ><div align='center'><strong>หน่วยงาน</strong></div></th>
          <th style='border:solid 1px #000000; width:2.5cm;' ><div align='center'><strong>ข้าราชการ</strong></div></th>
          <th style='border:solid 1px #000000; width:2.5cm;' ><div align='center'><strong>ลูกจ่้างประจำ</strong></div></th>
          <th style='border:solid 1px #000000; width:2.5cm;' ><div align='center'><strong>พนักงานราชการ</strong></div></th>
          <th style='border:solid 1px #000000; width:2.5cm;' ><div align='center'><strong>รวม</strong></div></th>  
          <th style='border:solid 1px #000000; width:3.5cm;' ><div align='center'><strong>หมายเหตุ</strong></div></th>  
    </tr>
  </thead>
	"; 
	...
	foreach ($arr_org as $key => $value) {
		...
		$html  .= "<tr  style='height:0.7cm;'> 
			 ...
			 <td CENTER_TOP >".number_format($regular_emp_num,0)."</td> 
			 <td CENTER_TOP >".number_format($temp_emp_num,0)."</td> 	
       ...
       <div class="col-xs-12 col-md-3">
          <div class="btn-group">
              ...
              <ul class="dropdown-menu" role="menu">	
               ...
               <form id="frm-export" method="post" action="profile_his_report_1_2_pdf.php">
