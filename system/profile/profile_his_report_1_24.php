...
$headline_title = " รายงานข้อมูลข้าราชการ ที่ผ่านการฝึกอบรมหลักสูตรแยกตามสำนัก/กอง        ";
$menu_name = 24;
...
<div id="content" class="container-full">
	...
	<div class="col-xs-12 col-md-12" id="content">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
                    <select id="LINE_ID" name="LINE_ID" class="selectbox form-control" placeholder="สำนัก/กอง "     >   
                      <option value=""></option>
                      <?php while($rec1 = $db->db_fetch_array($query_org)){?>
                        <option value="<?php echo $rec1['ORG_ID']?>"   >
                        <?php echo text($rec1['ORG_NAME_TH'])?></option>
                      <?php }?>
                    </select>			
            </div>
            <div class="col-xs-12 col-sm-1"></div>
			<div class="col-xs-12 col-sm-2" style="white-space:nowrap;"> 	<button type="button" class="btn btn-primary" onClick="searchData();">ค้นหา</button>	 </div>
  ...
  <tr class='bgHead'>
    ...
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>สำนัก/กอง </strong></div></th>
    <th style=' border:solid 1px #000000;  '  ><div align='center'><strong>ฝึกอบรมหลักสูตร </strong></div></th>
  </tr>
