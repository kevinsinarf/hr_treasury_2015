...
<script src="js/pension_record_edit_emp_form.js?<?php echo rand(); ?>"></script>
</head>
           ...
           <div id="div_4" >
            ...
            <div id="collapse10" class="collapse">
                ...
                <div class="row formSep">
                    ...
                    <div class="col-xs-12 col-md-2">
                    	<input type="text" id="LEGENCY_ALL" name="LEGENCY_ALL" class="form-control " value="<?php echo number_format($rec_main['LEGENCY_ALL'],2); ?>"  onBlur="NumberFormat(this,2);">
                    </div>
                </div>	
