...
<div class="container-full">
    ...
    <div class="col-xs-12 col-sm-12">
        <ol class="breadcrumb">
          ...
          <li><a href="profile_his_disp.php?<?php echo $page_back."?".url2code($link2);?>"><?php echo Showmenu($menu_sub_id);?></a></li>
            ...
            <table class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="25%"><div align="center"><strong>ชื่อใบประกอบวิชาชีพ</strong> </div></th>
                  <th width="15%"><div align="center"><strong>หน่วยงานที่ออกให้</strong></div></th>
                  <th width="8%"><div align="center"><strong>เลขที่ใบอนุญาติ</strong></div></th>
                  <th width="8%"><div align="center"><strong>วันที่มีผลบังคับใช้</strong></div></th>
				...
				if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						...
						if(chkPermission($menu_sub_id, 'edit')=='1'){
							$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["CERTHIS_ID"]."');\">".$img_edit." แก้ไข</a> ";
						}
						if(chkPermission($menu_sub_id, 'delete')=='1'){
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["CERTHIS_ID"]."');\">".$img_del." ลบ</a> ";
						}
				?>  
                <tr bgcolor="#FFFFFF">
                  ...
                  <td align="center"><?php echo text($rec["CERTHIS_NO"]); ?></td>
                  <td align="center"><?php echo conv_date($rec["CERTHIS_DATE"], 'short'); ?></td>
