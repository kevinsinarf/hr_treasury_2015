...
//ระดับตำแหน่ง/กลุ่มงาน
$arr_poss_level=GetSqlSelectArray("LEVEL_ID", "LEVEL_NAME_TH", "SETUP_POS_LEVEL", "DELETE_FLAG='0'   AND POSTYPE_ID = '".$POSTYPE_ID."' ", "LEVEL_SEQ");
}
if($POSTYPE_ID==1||$POSTYPE_ID==5){
//ตำแหน่งในสายงาน
...
if($POSTYPE_ID==5){
	$arr_pos_level=GetSqlSelectArray("LEVEL_ID", "LEVEL_NAME_TH", "SETUP_POS_LEVEL", "DELETE_FLAG='0'  AND TYPE_ID = '".$rec['TYPE_ID']."' AND POSTYPE_ID = '".$POSTYPE_ID."' ", "LEVEL_SEQ");
}
//สายงาน
...
//org1
$arr_org1=GetSqlSelectArray("a.ORG_ID", "a.ORG_NAME_TH", "SETUP_ORG as a ", "a.DELETE_FLAG='0' AND a.OL_ID='2' ", "case when ORG_SEQ IS NULL then 1 else 0 end, ORG_SEQ");
//org2

$arr_org2=GetSqlSelectArray("a.ORG_ID", "a.ORG_NAME_TH", "SETUP_ORG as a ", " a.DELETE_FLAG='0' AND a.ORG_PARENT_ID='".$rec['ORG_ID_1']."' ", "case when ORG_SEQ IS NULL then 1 else 0 end, ORG_SEQ ");
//org3
$arr_org3=GetSqlSelectArray("a.ORG_ID", "a.ORG_NAME_TH", "SETUP_ORG as a", "a.DELETE_FLAG='0' AND a.ORG_PARENT_ID='".$rec['ORG_ID_2']."' ", "case when ORG_SEQ IS NULL then 1 else 0 end, ORG_SEQ");
//org4
$arr_org4=GetSqlSelectArray( "a.ORG_ID", "a.ORG_NAME_TH", "SETUP_ORG as a ", "a.DELETE_FLAG='0' AND a.ORG_PARENT_ID='".$rec['ORG_ID_3']."'  ", "case when ORG_SEQ IS NULL then 1 else 0 end, ORG_SEQ");

$arr_org5=GetSqlSelectArray( "a.ORG_ID", "a.ORG_NAME_TH", "SETUP_ORG as a ", "a.DELETE_FLAG='0' AND a.ORG_PARENT_ID='".$rec['ORG_ID_4']."'  ", "case when ORG_SEQ IS NULL then 1 else 0 end, ORG_SEQ");
//ประเภทการเคลื่อนไหว
$arr_mov_type = GetSqlSelectArray("MOVEMENT_ID", "MOVEMENT_NAME_TH", "SETUP_MOVEMENT", "DELETE_FLAG='0'  AND  MOVEMENT_GROUP = '1' AND POSTYPE_ID = '".$POSTYPE_ID."' ","MOVEMENT_SEQ");
...
$TYPE_LIVE = $rec['TYPE_LIVE'];
if(trim($TYPE_LIVE) == '' and $proc == 'add'){
	$TYPE_LIVE = 1;
}
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12">
    <ol class="breadcrumb">
	  ...
	  <li><a href="profile_positionhis.php?<?php echo url2code($link2); ?>">ประวัติการดำรงตำแหน่ง</a></li>
...
<div class="groupdata" > <br>
	<?php include ("tab_info.php"); ?>
     <div class="clearfix"></div>
   	 <form id="frm-input" method="post" action="process/profile_positionhis_process.php" enctype="multipart/form-data">
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-md-2">				
                <div class="input-group">
                    <input type="text" id="POSHIS_DATE" name="POSHIS_DATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10" value="<?php echo $rec["POSHIS_DATE"]==''?'':conv_date(text($rec["POSHIS_DATE"]),''); ?>" >
            ...
            <div class="col-xs-12 col-md-2">				
                ...
                <div class="row formSep">
            		...
            		<div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect('TYPE_LIVE','TYPE_LIVE',$arr_poshis_live,'ประเภทการถือครอง',$TYPE_LIVE,'','','1','','2');?></div><div class="col-xs-12 col-sm-1"></div>
                 ...
                 <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-sm-8"><textarea id="POSHIS_NOTE" name="POSHIS_NOTE" class="form-control" placeholder="หมายเหตุ" maxlength="255"  ><?php echo  text(trim($rec["POSHIS_NOTE"]));?></textarea></div> 		
                 </div>
				</div>
                 <div class="row head-form">
                      <div class="col-xs-12 col-md-2" style="white-space:nowrap;">
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect('LEVEL_ID','LEVEL_ID',$arr_poss_level,'ระดับตำแหน่ง',$rec['LEVEL_ID'],'','','1');?></div> 
        </div>	
        <div class="row formSep">
       ...
       <?php if($POSTYPE_ID==3){?>
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-md-3"><span id='ss_org3'><?php echo GetHtmlSelect('ORG_ID_3','ORG_ID_3',$arr_org3,'ระดับกอง/สำนัก/กลุ่ม',$rec['ORG_ID_3'],'onchange="getORG(this);"','','1','300');?></span></div> 
        </div>
        
        <div class="row formSep">
            <div class="col-xs-12 col-md-2" style="white-space:nowrap">กลุ่มงาน/ส่วน : <span style="color:red;">*</span> </div>
            <div class="col-xs-12 col-md-3"><span id='ss_org4'><?php  echo GetHtmlSelect('ORG_ID_4','ORG_ID_4',$arr_org4,'ระดับส่วน/กลุ่มงาน ',$rec['ORG_ID_4'],'onchange="getORG(this);" ','','');?></span></div>
            <div class="col-xs-12 col-md-1"></div> 
              <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ฝ่าย  :  </div>
            <div class="col-xs-12 col-md-3"><span id='ss_org5_1'>
                <?php  echo GetHtmlSelect('ORG_ID_5','ORG_ID_5',$arr_org5,'ฝ่าย ',$rec['ORG_ID_5'],'','','1');?></span>
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect('TYPE_ID','TYPE_ID',$arr_pos_type,'ประเภทตำแหน่ง',$rec['TYPE_ID'],'onchange="getlevel(this.value,\''.$POSTYPE_ID.'\');"','',$POSTYPE_ID);?></div> 
            <div class="col-xs-12 col-md-1"></div>
      ...
      <?PHP if($PT_ID==3){ ?>
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect('TYPE_ID','TYPE_ID',$arr_pos_type,'กลุ่ม',$rec['TYPE_ID'],'onChange="getlevel(this.value,\''.$POSTYPE_ID.'\'); getLineGroup(this.value,\''.$POSTYPE_ID.'\'); "','','1');?></div> 
               <div class="col-xs-12 col-sm-1"></div>
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">สายงาน : <span style="color:red;">*</span></div>
         <div class="col-xs-12 col-sm-3">
		 	<?php echo GetHtmlSelect('LG_ID','LG_ID',$arr_pos_lg,'สายงาน',$rec['LG_ID'],'onChange="GetLineGov(this.value,\''.$POSTYPE_ID.'\');"','','1');?></span></div>
        </div>
	    <div class="row formSep">
             <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ตำแหน่งในสายงาน : <span style="color:red;">*</span></div>
            <div class="col-xs-12 col-sm-3"><span id='ss_pos_line'><?php  echo GetHtmlSelect('LINE_ID','LINE_ID',$arr_pos_line,'ตำแหน่งในสายงาน',$rec['LINE_ID'],'','','1');?></span></div>
    ...
    <!-- //-------------------------------------------------------------- -->
            ...
            <div class="col-xs-12 col-md-2"><input type="text" id="SALARY_POSITION" name="SALARY_POSITION" class="form-control number" placeholder="เงินเดือนประจำตำแหน่ง" maxlength="100" onBlur="number_format(this,2);" value="<?php echo number_format($rec['SALARY_POSITION'],2); ?>"></div>
                  
                   </div>
                    <div class="row formSep">
                    		  <div class="col-xs-12 col-md-3" style="white-space:nowrap;">เงินค่าตอบแทนนอกเหนือจากเงินเดือน  :  &nbsp;</div>
            <div class="col-xs-12 col-md-2"><input type="text" id="COMPENSATION_1" name="COMPENSATION_1" class="form-control number" placeholder="เงินค่าตอบแทนนอกเหนือจากเงินเดือน" onBlur="number_format(this,2);" maxlength="100" value="<?php echo number_format($rec['COMPENSATION_1'],2); ?>"></div>
            <div class="col-xs-12 col-md-1"></div>
             <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ค่าตอบแทนพิเศษ (เงินเดือนเต็มขั้น)  :  &nbsp;</div>
            <div class="col-xs-12 col-md-2"><input type="text" id="COMPENSATION_2" name="COMPENSATION_2" class="form-control number" placeholder="เงินค่าตอบแทนนอกเหนือจากเงินเดือน" maxlength="100" onBlur="number_format(this,2);"  value="<?php echo number_format($rec['COMPENSATION_2'],2); ?>"></div>
             </div>
              <div class="row formSep">
              <div class="col-xs-12 col-md-3" style="white-space:nowrap;">เงินเพิ่มพิเศษสำหรับการสู้รบ (พ.ส.ร.)  :  </div>
            <div class="col-xs-12 col-md-2"><input type="text" id="COMPENSATION_3" name="COMPENSATION_3" class="form-control number" placeholder="เงินเพิ่มพิเศษสำหรับการสู้รบ (พ.ส.ร.)" maxlength="100"  onblur="number_format(this,2);" value="<?php echo number_format($rec['COMPENSATION_1'],2); ?>"></div>
            <div class="col-xs-12 col-md-1"></div>
             <div class="col-xs-12 col-md-2" style="white-space:nowrap;">เงินเพิ่มค่าครองชีพชั่วคราว   :  &nbsp;</div>
            <div class="col-xs-12 col-md-2 number"><input type="text" id="COMPENSATION_4" name="COMPENSATION_4" class="form-control number " placeholder="เงินเพิ่มค่าครองชีพชั่วคราว" maxlength="100"  onblur="number_format(this,2);" value="<?php echo number_format($rec['COMPENSATION_2'],2); ?>"></div>
            </div>
            </div>
            </div>
           <div class="row formSep">
              <div class="col-xs-12 col-md-3" >เงินเพิ่มสำหรับตำแหน่งที่มีเหตุพิเศษ : </div>
              <div class="col-xs-12 col-md-2">
                 <input type="text" id="COMPENSATION_5" name="COMPENSATION_5" class="form-control" placeholder="เงินเพิ่มค่าครองชีพชั่วคราว" maxlength="10"  value="<?php echo  number_format($rec["COMPENSATION_5"],2);?>" onBlur="NumberFormat(this,2);" >
              </div> 
          </div>                  
        ...
        <div class="col-xs-12 col-sm-12" align="center">
			...
			<button type="button" class="btn btn-default" onClick="self.location.href='profile_positionhis.php?<?php echo url2code($link2);?>';">ยกเลิก</button>
        </div>
        </div>
        <br>
    </form>
