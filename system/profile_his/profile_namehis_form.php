...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
	...
	<?php include ("tab_info.php"); ?>
      <form id="frm-input" method="post" action="process/profile_namehis_process.php" enctype="multipart/form-data">
        ...
        <div class="row formSep">
            <div class="col-xs-12 col-sm-2">วันที่แจ้งเปลี่ยนชื่อ - สกุล :&nbsp;<span style="color:red;">*</span></div>
            <div class="col-xs-12 col-md-2">
                <div class="input-group">
                    <input type="text" id="NAMEHIS_NOTICEDATE" name="NAMEHIS_NOTICEDATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10" value="<?php echo  conv_date($data["NAMEHIS_NOTICEDATE"]);?>">
        ...
        <div class="col-xs-12 col-sm-12" align="center">
          ...
          <button type="button" class="btn btn-default" onClick="self.location.href='profile_namehis.php?<?php echo url2code($link2);?>';">ยกเลิก</button>
        </div>
        <br>
		</form>
    </div>	
