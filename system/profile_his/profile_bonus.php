...
<div class="container-full">
 ...
 <!--       <div class="row">
        ...
        <div class="row">
                    ...
                    <div class="col-xs-12 col-md-3">
                        <?php echo GetHtmlSelect('TYPE_ID', 'TYPE_ID',$arr_pos_type , $arr_txt['type_pos'] ,$TYPE_ID,' onChange="get_line_1(this) ;get_level_1(this);get_lg_1(this);" ', '1', '', ''); ?>	
                    </div>
                     <div class="col-xs-12 col-md-1"></div>
               	...
               	if($nums > 0){
                    ...
                    while($rec = $db->db_fetch_array($query)){
                        if($rec['POSHIS_DEFAULT']!="1"){
                            $edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["BOUNUSHIS_ID"]."');\">".$img_edit." แก้ไข</a> ";
                            $delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["BOUNUSHIS_ID"]."');\">".$img_del." ลบ</a> ";
							$position = "<strong>".$arr_txt['pos_no'].": </strong>".$rec['POS_NO']."</br>";
							$position .= "<strong>.".$arr_txt['type_pos'].": </strong>".text($arr_pos_type[$rec['TYPE_ID']])."</br>";
						...
						echo "<tr><td align=\"center\" colspan=\"10\">".$arr_txt['data_not_found']."</td></tr>";
					}
                  ?>
                </tbody>
              </table>
