...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12" id="content">
	...
	<div class="clearfix"></div>
      <form id="frm-input" method="post" action="process/profile_contact_process.php" enctype="multipart/form-data">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div id="collapse1" class="collapse in">
                <div class="row formSep">
                    ...
                    <div class="col-md-2 col-sm-2">
                        <div class="input-group">
                            <input type="text" id="FAMILY_DATE" name="FAMILY_DATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo  conv_date($rec["FAMILY_DATE"]);?>">
                    ...
                    <div class="col-md-2 col-sm-2"><?php echo GetHtmlSelect('FAMILY_RELATIONSHIP', 'FAMILY_RELATIONSHIP',$arr_family_relation, "ความสัมพันธ์", $rec['FAMILY_RELATIONSHIP'],'onchange="chkFamilyType(this.value);"','','1','','2');?></div>
                </div>
                ...
                <div class="row formSep">
                    <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อตัว (อังกฤษ) : </div>
                    ...
                    <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ชื่อสกุล (อังกฤษ) : </div>
        ...
        <span id="shw_family_type4">
            <div class="panel-group" id="accordion">
                ...
                <div id="collapse5" class="collapse in">
                    <div class="row formSep">
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">เลขที่ :</div>
                        <div class="col-xs-12 col-md-2"><input type="text" id="BIRTH_NO" name="BIRTH_NO"  class="form-control" placeholder="เลขที่" maxlength="100" value="<?php echo text($rec['BIRTH_NO']); ?>"></div>
                        <div class="col-xs-12 col-sm-2"></div>
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ลงวันที่ :</div>
                        <div class="col-xs-12 col-md-2">
                            <div class="input-group">
                                <input type="text" id="BIRTH_DATE" name="BIRTH_DATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo  conv_date($rec["BIRTH_DATE"]);?>">
                                <span class="input-group-addon datepicker" for="BIRTH_DATE" >&nbsp;
                                <span class="glyphicon glyphicon-calendar"></span>&nbsp;
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-1"><input type="text" id="BIRTH_SEQ" name="BIRTH_SEQ"  class="form-control" placeholder="ลำดับ" maxlength="3" value="<?php echo text($rec['BIRTH_SEQ']); ?>"></div>
                        <div class="col-xs-12 col-sm-3"></div>
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ออก ณ :</div>
                        <div class="col-xs-12 col-md-3"><input type="text" id="BIRTH_PLACE" name="BIRTH_PLACE"  class="form-control" placeholder="ออก ณ" value="<?php echo text($rec['BIRTH_PLACE']); ?>"></div>
                    </div>
                    
                    <div class="row formSep">
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">คู่สมรส :</div>
                        <div class="col-xs-12 col-md-2"><?php echo GetHtmlSelect('BIRTH_MARRY_ID','BIRTH_MARRY_ID',$arr_family,'คู่สมรส',$rec['BIRTH_MARRY_ID'], '','','1','','2');?></div>
                        <div class="col-xs-12 col-sm-2"></div>
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ไฟล์แนบ :</div>
                        <div class="col-xs-12 col-md-3">
                        	<div class="input-group"  >
                                <input type="file" id="BIRTH_FILE" name="BIRTH_FILE"  class="form-control" placeholder="ไฟล์แนบ" value="<?php echo text($rec['BIRTH_FILE']); ?>">
                    ...
                    <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-2"><input type="text" id="BIRTH_CERT_NO" name="BIRTH_CERT_NO"  class="form-control" placeholder="เลขที่ทะเบียนรับรองบุตร/คำสั่งศาล" value="<?php echo text($rec['BIRTH_CERT_NO']); ?>"></div>
                        <div class="col-xs-12 col-sm-2"></div>
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ลงวันที่ :</div>
                        <div class="col-xs-12 col-md-2">
                            <div class="input-group">
                                <input type="text" id="BIRTH_CERT_DATE" name="BIRTH_CERT_DATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo  conv_date($rec["BIRTH_CERT_DATE"]);?>">
                                <span class="input-group-addon datepicker" for="BIRTH_CERT_DATE" >&nbsp;
                                <span class="glyphicon glyphicon-calendar"></span>&nbsp;
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="row formSep">
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ออก ณ :</div>
                        <div class="col-xs-12 col-md-3"><input type="text" id="BIRTH_CERT_PLACE" name="BIRTH_CERT_PLACE"  class="form-control" placeholder="ออก ณ" value="<?php echo text($rec['BIRTH_CERT_PLACE']); ?>"></div>
                        <div class="col-xs-12 col-sm-1"></div>
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ไฟล์แนบ :</div>
                        <div class="col-xs-12 col-md-3">
                        	<div class="input-group"  >
                                <input type="file" id="BIRTH_CERT_FILE" name="BIRTH_CERT_FILE"  class="form-control" placeholder="ไฟล์แนบ" value="<?php echo text($rec['BIRTH_CERT_FILE']); ?>">
            ...
            <div class="panel-group" id="accordion">
                ...
                <div id="collapse6" class="collapse in">
                    <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-2"><input type="text" id="PROTEGE_SNO" name="PROTEGE_SNO"  class="form-control" placeholder="เลขที่ใบรับรองบุตรบุญธรรม" value="<?php echo text($rec['PROTEGE_SNO']); ?>"></div>
                        <div class="col-xs-12 col-sm-2"></div>
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ลงวันที่ :</div>
                        <div class="col-xs-12 col-md-2">
                            <div class="input-group">
                                <input type="text" id="PROTEGE_SDATE" name="PROTEGE_SDATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo  conv_date($rec["PROTEGE_SDATE"]);?>">
                                <span class="input-group-addon datepicker" for="PROTEGE_SDATE" >&nbsp;
                                <span class="glyphicon glyphicon-calendar"></span>&nbsp;
                                </span>
                            </div>
                        </div>
                    ...
                    <div class="row formSep">
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">จังหวัด :</div>
                        <div class="col-xs-12 col-md-2"><?php echo GetHtmlSelect('PROTEGE_SPROV_ID','PROTEGE_SPROV_ID',$arr_prov,'จังหวัด',$rec['PROTEGE_SPROV_ID'], 'onchange="getRampr(this,\'PROTEGE_SAMPR_ID\',\'PROTEGE_STAMB_ID\',\'ss_protege_sampr\');" ','','1');?></div>
                        <div class="col-xs-12 col-sm-2"></div>
                        <div class="col-xs-12 col-md-2" style="white-space:nowrap;">อำเภอ/เขต :</div>
                        <div class="col-xs-12 col-md-2"><span id='ss_protege_sampr'><?php echo GetHtmlSelect('PROTEGE_SAMPR_ID','PROTEGE_SAMPR_ID',$arr_ampr_sprotege,'อำเภอ/เขต',$rec['PROTEGE_SAMPR_ID'],'','1');?></span></div>
                    </div>
                    ...
                    <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-3">
                        	<div class="input-group"  >
                                <input type="file" id="PROTEGE_SFILE" name="PROTEGE_SFILE"  class="form-control" placeholder="ไฟล์แนบ" value="<?php echo text($rec['PROTEGE_SFILE']); ?>">
                        ...
                        <div class="col-xs-12 col-md-2"><?php echo GetHtmlSelect('PROTEGE_STATUS','PROTEGE_STATUS',$arr_protege_status,'สถานะของการรับรองบุตรบุญธรรม',$rec['PROTEGE_STATUS'], 'onchange="chkProtegeStatus(this.value);"','','1','','2');?></div>
                    </div>
                    
                    <span id="shw_protege_e">
                        <div class="row formSep">
                            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">เลขที่ใบเลิกรับบุตรบุญธรรม :</div>
                            <div class="col-xs-12 col-md-2"><input type="text" id="PROTEGE_ENO" name="PROTEGE_ENO"  class="form-control" placeholder="เลขที่ใบเลิกรับบุตรบุญธรรม" value="<?php echo text($rec['PROTEGE_ENO']); ?>"></div>
                            <div class="col-xs-12 col-sm-2"></div>
                            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">ลงวันที่ :</div>
                            <div class="col-xs-12 col-md-2">
                                <div class="input-group">
                                    <input type="text" id="PROTEGE_EDATE" name="PROTEGE_EDATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo  conv_date($rec["PROTEGE_EDATE"]);?>">
                                    <span class="input-group-addon datepicker" for="PROTEGE_EDATE" >&nbsp;
                                    <span class="glyphicon glyphicon-calendar"></span>&nbsp;
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="row formSep">
                            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">จังหวัด :</div>
                            <div class="col-xs-12 col-md-2"><?php echo GetHtmlSelect('PROTEGE_EPROV_ID','PROTEGE_EPROV_ID',$arr_prov,'จังหวัด',$rec['PROTEGE_EPROV_ID'], 'onchange="getRampr(this,\'PROTEGE_EAMPR_ID\',\'PROTEGE_ETAMB_ID\',\'ss_protege_eampr\');" ','','1');?></div>
                            <div class="col-xs-12 col-sm-2"></div>
                            <div class="col-xs-12 col-md-2" style="white-space:nowrap;">อำเภอ/เขต :</div>
                            <div class="col-xs-12 col-md-2"><span id='ss_protege_eampr'><?php echo GetHtmlSelect('PROTEGE_EAMPR_ID','PROTEGE_EAMPR_ID',$arr_ampr_eprotege,'อำเภอ/เขต',$rec['PROTEGE_EAMPR_ID'],'','1');?></span></div>
                        </div>
                        ...
                        <div class="row formSep">
                            ...
                            <div class="col-xs-12 col-md-3">
                                <div class="input-group"  >
                                    <input type="file" id="PROTEGE_EFILE" name="PROTEGE_EFILE"  class="form-control" placeholder="ไฟล์แนบ" value="<?php echo text($rec['PROTEGE_EFILE']); ?>">
        ...
        <div class="col-xs-12 col-sm-12" align="center" style="margin-top:10px;">
          ...
          <button type="button" class="btn btn-default" onClick="self.location.href='profile_contact_disp.php?<?php echo url2code($link2);?>';">ยกเลิก</button>
        </div>
        <br>
      </form>
    </div>
