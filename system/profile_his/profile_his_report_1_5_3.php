...
$headline_title =  $report_menu[$menu_name]['name'];
   ...
   //$sql_line = "select EL_ID, EL_NAME_TH  from SETUP_EDU_LEVEL   ORDER BY EL_SEQ ASC";
...
WHERE a.ACTIVE_STATUS = 1 ";
   ...
   $sql_country = "select a.COUNTRY_ID,b.COUNTRY_NAME_TH ,c.PER_GENDER,c.PT_ID  from PER_EDUCATEHIS a
   ...
   if($SEARCH_TYPE==1){  
        $sql_get_value = $sql_line;  
		   ...
		   $q_where = ' AND a.EL_ID = '.$EL_ID.' ';
			...
			$sql_get_value = $db->query($sql_line); 
