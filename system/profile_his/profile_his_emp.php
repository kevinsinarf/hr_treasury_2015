...
$pk_id=" a.PER_ID";
$wh=" a.DELETE_FLAG='0' AND  a.PT_ID='".$PT_ID."' {$filter}";
...
$cond_org4 =  " AND ORG_PARENT_ID = '".$S_ORG_ID_3."' ";
...
<script src="js/profile_his_emp.js?<?php echo rand(); ?>"></script>
</head>
  ...
  <div class="col-xs-12 col-sm-12"  id="content">
    <div class="groupdata">
        ...
        <div class="row">
			...
			<div class="col-xs-12 col-sm-3"><?php echo GetHtmlSelect('S_ORG_ID_3', 'S_ORG_ID_3',$arr_setup_org3 , 'สำนัก' ,$S_ORG_ID_3,' onChange="getORG(this); " ' , '1', '', ''); ?></div>
			<div class="col-xs-12 col-sm-2"></div>
