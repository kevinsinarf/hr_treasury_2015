  ...
  <div class="col-xs-12 col-sm-12" id="content">
	...
	<div class="clearfix"></div>
      <form id="frm-input" method="post" action="process/profile_approvehis_educatehis_process.php" enctype="multipart/form-data">
        ...
        <div class="clearfix"></div>
		<div class="row formSep">
      		<div class="col-xs-12 col-sm-2" style="white-space:nowrap">วันที่ขอเปลี่ยนแปลง&nbsp;:&nbsp;<span style="color:red;">*</span></div>
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-3">
            <label ><input type="radio" id="EDU_SCHOLARSHIP1" name="EDU_SCHOLARSHIP"  value="1" <?php echo ($rec['EDU_SCHOLARSHIP']=='1'||$data['EDU_SCHOLARSHIP']=='' ?"checked":"")?>>  <?php echo $arr_scholarship['1'];?></label>&nbsp;&nbsp;
