                ...
                <?php
			   	if($nums > 0){
					...
					while($rec = $db->db_fetch_array($query)){
						$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["DEH_ID"]."');\">".$img_edit." แก้ไข</a> ";
						if($rec['POSHIS_DEFAULT']!="1"){
							$delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["DEH_ID"]."');\">".$img_del." ลบ</a> ";
						}
						?>
						<tr bgcolor="#FFFFFF">
