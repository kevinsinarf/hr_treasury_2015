...
$arr_command_type = GetSqlSelectArray("CT_ID", "CT_NAME_TH", "SETUP_COMMAND_TYPE", "ACTIVE_STATUS = '1' AND DELETE_FLAG = '0' AND LT_ID = '1' ", "CT_NAME_TH");
...
<div class="groupdata" > <br>
    ...
    <form id="frm-input" method="post" action="process/profile_servicehis_process.php" enctype="multipart/form-data">
        ...
        <div class="panel-group" id="accordion">
            ...
            <div id="collapse1" class="collapse in">
                <div class="row formSep">
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ประเภทคำสั่ง : <span style="color:red;"> *</span></div>
                    <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect('CT_ID','CT_ID',$arr_command_type,'ประเภทคำสั่ง',$rec['CT_ID'],'','','1');?></div> 
                    <div class="col-xs-12 col-sm-1"></div>
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ประเภทความเคลื่อนไหว : <span style="color:red;"> *</span></div>
                    <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect('MOVEMENT_ID','MOVEMENT_ID',$arr_movement,'ประเภทความเคลื่อนไหว',$rec['MOVEMENT_ID'],'','','1');?></div> 
                </div>
                
                <div class="row formSep">
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">เลขที่คำสั่ง : <span style="color:red;"> *</span><span style="color:red;"></span></div>
                    <div class="col-xs-12 col-sm-2"><input type="text" name="COM_NO" id="COM_NO" class="form-control" placeholder="เลขที่คำสั่ง" value="<?php echo $rec['COM_NO'];?>"></div> 
                    <div class="col-xs-12 col-sm-2"></div>
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ลงวันที่ : <span style="color:red;"> *</span></div>
                    <div class="col-xs-12 col-sm-2">
                    	<div class="input-group">
                            <input type="text" id="COM_DATE" name="COM_DATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo conv_date($rec["COM_DATE"]);?>">
                ...
                <!--  <div class="col-xs-12 col-sm-2" style="white-space:nowrap">วันที่บันทึก : </div>
                    ...
                    <div class="col-xs-12 col-sm-2">
                    	<div class="input-group">
                            <input type="text" id="COM_SDATE" name="COM_SDATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo conv_date($rec["COM_SDATE"]);?>">
                ...
                <div class="row formSep">
                    ...
                    <div class="col-xs-12 col-sm-6"><input type="text" name="SPECHIS_PROJECT" id="SPECHIS_PROJECT" class="form-control" placeholder="โครงการ" value="<?php echo $rec['SPECHIS_PROJECT'];?>"></div> 
                </div>
                
                <div class="row formSep">
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ประเภทการให้บริการราชการพิเศษ : </div>
                    <div class="col-xs-12 col-sm-2"><?php  echo GetHtmlSelect('SPECHIS_TYPE','SPECHIS_TYPE',$arr_special_type,'ประเภทการให้บริการราชการพิเศษ',$rec['SPECHIS_TYPE'],'onchange="getPosition(this.value);"','','1','','2');?></div> 
                    <div class="col-xs-12 col-sm-2"></div>
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ตำแหน่ง : <span style="color:red;"> *</span> </div>
                    <div class="col-xs-12 col-sm-3"><span id="shw_pos"><?php echo GetHtmlSelect('SPECIAL_ID','SPECIAL_ID',$arr_special,'ตำแหน่ง',$rec['SPECIAL_ID'],'','','1','','1');?></span></div> 
                </div>
                
                <div class="row formSep">
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">สถานะของการปฏิบัติราชการพิเศษ : </div>
                    <div class="col-xs-12 col-sm-3"><?php  echo GetHtmlSelect('SPECHIS_ETYPE','SPECHIS_ETYPE',$arr_special_etype,'สถานะของการปฏิบัติราชการพิเศษ',$rec['SPECHIS_ETYPE'],'','','1','','2');?></div> 
                    <div class="col-xs-12 col-sm-1"></div>
                    <div class="col-xs-12 col-sm-2" style="white-space:nowrap">วันที่แล้วเสร็จ/สิ้นสุด : </div>
                    <div class="col-xs-12 col-sm-2">
                  		<div class="input-group">
                            <input type="text" id="SPECHIS_EDATE" name="SPECHIS_EDATE" class="form-control" placeholder="DD/MM/YYYY" maxlength="10"  value="<?php echo conv_date($rec["SPECHIS_EDATE"]);?>">
                            <span class="input-group-addon datepicker" for="SPECHIS_EDATE" >&nbsp;
                            <span class="glyphicon glyphicon-calendar"></span>&nbsp;
                            </span>
                        </div>
                    </div> 
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-md-3">
                <input type="text" id="POS_NO" name="POS_NO" class="form-control number" placeholder="<?php echo $arr_txt['pos_no']; ?>" value="<?php  echo text($rec["POS_NO"]); ?>" style="width:170px;">
          	</div>
            <div class="col-xs-12 col-md-1"></div>
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">กระทรวง : <span style="color:red;"> *</span></div>
            <div class="col-xs-12 col-sm-3">
				<?php  echo GetHtmlSelect('ORG_ID_1','ORG_ID_1',$arr_org1,'กระทรวง',$rec['ORG_ID_1'], " onchange='getORG(this);' ",'','');?>
            </div>
        </div>
        
        <div class="row formSep">
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">กรม/สำนักงาน : <span style="color:red;"> *</span></div>
            <div class="col-xs-12 col-sm-3">
				<?php  echo GetHtmlSelect('ORG_ID_2','ORG_ID_2',$arr_org2,'กรม/สำนักงาน',$rec['ORG_ID_2'],"onchange='getORG(this);' ",'','');?>
            </div> 
            <div class="col-xs-12 col-md-1"></div>
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">สำนัก/กอง/กลุ่ม : <span style="color:red;"> *</span></div>
            <div class="col-xs-12 col-sm-3">
     			<?php echo GetHtmlSelect('ORG_ID_3','ORG_ID_3',$arr_org3,'สำนัก/กอง/กลุ่ม',$rec['ORG_ID_3'],"onchange='getORG(this);'",'','1');?>
            </div> 
        </div>
        <div class="row formSep">
            <div class="col-xs-12 col-sm-2" style="white-space:nowrap">กลุ่มงาน/ส่วน : <span style="color:red;"> *</span></div>
            <div class="col-xs-12 col-sm-3">
     			<?php echo GetHtmlSelect('ORG_ID_4','ORG_ID_4',$arr_org4,'กลุ่มงาน/ส่วน',$rec['ORG_ID_4'],"onchange='getORG(this);' ",'','1');?>
            </div> 
            <div class="col-xs-12 col-md-1"></div>
           <div class="col-xs-12 col-sm-2" style="white-space:nowrap">ฝ่าย : </div>
            <div class="col-xs-12 col-sm-3">
     			<?php echo GetHtmlSelect('ORG_ID_5','ORG_ID_5',$arr_org5,'ฝ่าย',$rec['ORG_ID_5'],"onchange='getORG(this);' ",'','1');?>
            </div>
        </div>
         <!------------ข้าราชการ---------------------------------------------------------------->  
          <?php if($POSTYPE_ID == 1){ ?>
                    <div class="row formSep">
                    	...
                    	<div class="col-xs-12 col-md-2 col-md-offset-1" >ระดับตำแหน่ง : <span style="color:red;"> *</span></div>
                    	<div class="col-xs-12 col-md-3"><?php echo GetHtmlSelect('LEVEL_ID', 'LEVEL_ID',$arr_poss_level , 'ระดับ' ,$rec['LEVEL_ID'] ,'','', '', '300', '1'); ?></div>
                    </div>
                     ...
                     <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-2 col-md-offset-1 " >ตำแหน่งในสายงาน : <span style="color:red;"> *</span>&nbsp;</div>
                        <div class="col-xs-12 col-md-3"><?php echo GetHtmlSelect('LINE_ID', 'LINE_ID',$arr_pos_line, 'ตำแหน่งในสายงาน' ,$rec['LINE_ID'] ,'', '', '', '300', '1'); ?></div>
                    </div>
                ...
                <div class="row formSep">
                  ...
                  <div class="row formSep">
                        ...
                        <div class="col-xs-12 col-md-3">
							<?php echo GetHtmlSelect('LEVEL_ID', 'LEVEL_ID',$arr_poss_level , 'ประเภทกลุ่มงาน' ,$rec['LEVEL_ID'] ," onChange='get_line(this); ' ",'', '', '300', '1'); ?>
                        </div>
                        <div class="col-xs-12 col-md-2 col-md-offset-1 " >ตำแหน่ง : &nbsp;</div>
                        <div class="col-xs-12 col-md-3">
							<?php echo GetHtmlSelect('LINE_ID', 'LINE_ID',$arr_pos_line, 'ตำแหน่ง' ,$rec['LINE_ID'] ,'', '', '', '300', '1'); ?>
                        </div>
                    </div>
                <?php } ?>
                <?php if($POSTYPE_ID == 5){ ?>
                ...
                <div class="row formSep">
                  ...
                  <div class="col-xs-12 col-md-3">
				  	<?php echo GetHtmlSelect('LINE_ID', 'LINE_ID',$arr_pos_line, 'ตำแหน่งในสายงาน' ,$rec['LINE_ID'] ,'', '', '', '300', '1'); ?>
                  </div>
                  <div class="col-xs-12 col-md-2 col-md-offset-1 " >ระดับตำแหน่ง : &nbsp;</div>
                  <div class="col-xs-12 col-md-3">
                      <?php echo GetHtmlSelect('LEVEL_ID', 'LEVEL_ID',$arr_poss_level , 'ระดับตำแหน่ง' ,$rec['LEVEL_ID'] ," ",'', '', '300', '1'); ?>
                  </div>
                 </div>
              <?php } ?>
        ...
        <div class="col-xs-12 col-sm-12" align="center">
			...
			<button type="button" class="btn btn-default" onClick="self.location.href='profile_servicehis.php?<?php echo url2code($link2);?>';">ยกเลิก</button>
        </div>
        <br>
    </form>
</div>
