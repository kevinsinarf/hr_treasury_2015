...
$headline_title =  $report_menu[$menu_name]['name'];
   ...
   $sql_level = "select a.INS_ID, b.INS_NAME_TH+''+b.INS_NAME_EN as UNAME from PER_EDUCATEHIS a
LEFT JOIN SETUP_EDU_INSTITUTE b
on a.INS_ID = b.INS_ID 
WHERE a.ACTIVE_STATUS = 1 ";
 
	$query_level = $db->query($sql_level); 
	
   $sql_country = "select a.COUNTRY_ID,b.COUNTRY_NAME_TH from PER_EDUCATEHIS a
