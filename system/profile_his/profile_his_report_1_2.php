...
<div id="content" class="container-full">
 ...
 <?php echo btn_do_center("$('#SEARCH_TYPE').val(1);searchData();");    
	...
	foreach ($arr_org as $key => $value) {
		...
		//$query_get_regular = $db->query($sql_get_value." and PT_ID = 3  ");
		//$query_get_emp  = $db->query($sql_get_value." and PT_ID = 2  ");
		...
		$temp_emp_num =  $db->db_num_rows($query_get_emp);
            $temp_emp_sum = $temp_emp_sum + $temp_emp_num;
		...
		$html  .= "<tr  style='height:0.7cm;'> 
			 ...
			 <td RIGHT_TOP >".number_format($temp_emp_num,0)."&nbsp;&nbsp;</td> 	
			 <td RIGHT_TOP >".number_format($all_emp_num,0)."&nbsp;&nbsp;</td> 
	...
	/*
		$html  .= "<tr style='height:0.7cm;'> 
			 ...
			 <td RIGHT_TOP ><div  ><strong>".number_format($officer_sum,0)."&nbsp;&nbsp;</strong></div></td> 
			 <td RIGHT_TOP ><div  ><strong>".number_format($regular_emp_sum,0)."&nbsp;&nbsp;</strong></div></td> 
			 <td RIGHT_TOP ><div  ><strong>".number_format($temp_emp_sum,0)."&nbsp;&nbsp;</strong></div></td> 	
			 <td RIGHT_TOP ><div  ><strong>".number_format($sum_all,0)."&nbsp;&nbsp;</strong></div></td> 
