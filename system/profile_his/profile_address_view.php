...
$gg = "ดูประวัติการเปลี่ยนแปลง";

$field=" PADD_ID, PADD_DATE, PADD_TYPE, PADD_ROOM_NO, PADD_FLOOR, PADD_BUILDING, PADD_HOME_NO, PADD_MOO, PADD_VILLAGE, PADD_SOI, PADD_ROAD, 
		 PADD_TAMB_ID, PADD_AMPR_ID, PADD_PROV_ID, PADD_POSTCODE, PADD_TEL, PADD_TEL_EXT, PADD_FAX, PADD_FAX_EXT, PADD_MOBILE";	
$table=" PER_ADDRESS";
$orderby="order by PADD_DATE DESC";

$sql = "select ".$field." from ".$table." where DELETE_FLAG = '0' and PER_ID = '".$PER_ID."'  and PADD_TYPE = '".$PADD_TYPE."'".$orderby;
$query = $db->query($sql);
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			<li><a href="index.php?<?php echo $paramlink; ?>">หน้าแรก</a></li>
	  		...
	  		<li class="active"><?php echo $gg;?></li>
		</ol>
	</div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover table-condensed">
                                <thead>
                                    <tr class="bgHead">
                                        <th width="10%"><div align="center"><strong>วันที่แจ้ง</strong></div></th>
										<th width="12%"><div align="center"><strong>ประเภท</strong></div></th>
                                        <th width="35%"><div align="center"><strong>ที่อยู่</strong></div></th>
                                        <th width="25%" nowrap><div align="center"><strong>หมายเลขติดต่อ</strong></div></th>
                                    </tr>
                                </thead>
                                <tbody>
								<?php
                                if($nums > 0){
                                    ...
                                    while($rec = $db->db_fetch_array($query)){
										...
										?>
										<tr bgcolor="#FFFFFF">
											<td align="center"><?php echo conv_date($rec['PADD_DATE'],'short');?>&nbsp;</td>
