...
//ประเภทตำแหน่ง
$arr_pos_type=GetSqlSelectArray("TYPE_ID", "TYPE_NAME_TH", "SETUP_POS_TYPE", "ACTIVE_STATUS='1' and DELETE_FLAG='0' AND POSTYPE_ID = '1'   ".$wh_postype_id, "TYPE_SEQ");
...
function chk_me(){
   ...
   if(org_id_val==""){
        alert("กรุณาเลือก ประเภทตำแหน่ง ด้วยค่ะ");
...
<div id="content" class="container-full">
 ...
 <div class="row" style="margin:0 auto;"><button type="button" class="btn btn-primary" onClick="$('#SEARCH_TYPE').val(1);return chk_me();">ค้นหา</button></div>
 ...
 from  PER_PROFILE a 
	...
	LEFT JOIN SETUP_EDU_INSTITUTE g ON c.INS_ID = g.INS_id 
		...
		$PROV_TH_NAME_is = text($rec1['PROV_TH_NAME']);
 		...
 		$html  .= " <td LEFT_TOP >&nbsp;&nbsp;".$ORG_NAME_TH_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
 		$html  .= " <td CENTER_TOP >&nbsp;&nbsp;".$POS_ID_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
 		$html  .= " <td LEFT_TOP >&nbsp;&nbsp;".$LINE_NAME_TH_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
 		$html  .= " <td LEFT_TOP >&nbsp;&nbsp;".$TYPE_NAME_TH_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
 		$html  .= " <td CENTER_TOP >&nbsp;&nbsp;".$LEVEL_SHORTNAME_EN_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
		$html  .= " <td LEFT_TOP >&nbsp;&nbsp;".$LINE_NAME_TH_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
 		$html  .= " <td LEFT_TOP >&nbsp;&nbsp;".$temp_skill."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
		$html  .= " <td LEFT_TOP >&nbsp;&nbsp;".$OT_NAME_TH_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";		
 		$html  .= " <td LEFT_TOP >&nbsp;&nbsp;".$PROV_TH_NAME_is."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
		...
		$html  .= " <td RIGHT_TOP >&nbsp;&nbsp;".$man_salary."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
 		$html  .= " <td RIGHT_TOP >&nbsp;&nbsp;".$mansalaryposition."&nbsp;&nbsp;&nbsp;&nbsp;</td> ";
    ...
    <center> 
   <a href="profile_his_report_1_29csv.php?type_is_is=<?php echo $TYPE_ID; ?>&level_id_is=<?php echo $LEVEL_ID; ?>&menu_name=<?php echo $menu_name; ?>"  class="btn btn-primary"  role="button" target="_blank">
