...
$orderby = "ORDER BY A.ACTIVE_STATUS DESC, A.COM_SDATE ";
$groupby = "";
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12">
    <ol class="breadcrumb">
      ...
      <li class="active">ประวัติการดำรงตำแหน่ง</li>
    </ol>
  </div>
               	...
               	if($nums > 0){
                    ...
                    while($rec = $db->db_fetch_array($query)){
                        if($rec['POSHIS_DEFAULT']!="1"){
                            $edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"editData('".$rec["POSHIS_ID"]."');\">".$img_edit." แก้ไข</a> ";
                            $delete = "<button type=\"button\" class=\"btn btn-default btn-xs\" onClick=\"delData('".$rec["POSHIS_ID"]."');\">".$img_del." ลบ</a> ";
