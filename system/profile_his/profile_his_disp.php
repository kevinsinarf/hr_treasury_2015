...
$S_PER_STATUS_CIVIL = $_POST['S_PER_STATUS_CIVIL'];
if(trim($S_PER_STATUS_CIVIL) == ''){
	$S_PER_STATUS_CIVIL = 2; 
}
...
if($S_PER_STATUS_CIVIL > 0){
	$filter .= " and a.PER_STATUS_CIVIL = '".$S_PER_STATUS_CIVIL."' ";
}
...
$cond_org = " AND ORG_PARENT_ID = '".$s_org_3."' ";
    ...
    <div class="groupdata">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-3">
			  <?php  echo GetHtmlSelectNoConv('S_PER_STATUS_CIVIL','S_PER_STATUS_CIVIL',$arr_status_civil,'--ทั้งหมด--',$S_PER_STATUS_CIVIL,'','','1','500');?>
			</div>
        </div>
        ...
        <div class="row">
			...
			<div class="col-xs-12 col-sm-3">
            <select id="s_org_3" name="s_org_3" class="selectbox form-control" placeholder="--ทั้งหมด--" onChange="getORG(this);">
				<option value=""></option>
            ...
            <table width="397" class="table table-bordered table-striped table-hover table-condensed">
              <thead>
                <tr class="bgHead">
                  ...
                  <th width="5%"><div align="center"><strong>สถานะ</strong></div></th>
