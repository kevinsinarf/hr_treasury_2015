...
$pk_id=" a.PER_ID";
$wh=" a.ACTIVE_STATUS = 1 AND a.DELETE_FLAG='0' AND  a.POSTYPE_ID= 1 AND PER_STATUS_CIVIL = 2 {$filter}";
...
<script src="js/salary_leve_his_gov_disp.js?<?php echo rand(); ?>"></script>
</head>
