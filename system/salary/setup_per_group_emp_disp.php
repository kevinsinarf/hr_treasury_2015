...
$pk_id="A.ORG_ID";
$wh=" B.POSTYPE_ID = 3 AND B.YEAR_BDG = '".$S_YEAR_BDG."' AND B.ROUND = '".$S_ROUND."' {$filter} ";
...
<script src="js/setup_per_group_emp_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
	...
	<div class="col-xs-12 col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active">พนักงานราชการ->จัดกลุ่มสำหรับการเลื่อนค่าตอบแทน</li>
		</ol>
	</div>
			...
			<div class="table-responsive">
                <table align="center" class="table table-bordered table-striped table-hover table-condensed" id="tb_data">
					...
					while($rec = $db->db_fetch_array($query)){
						...
						$query_num = $db->query("SELECT COUNT(PER_ID) AS COUNT_PER FROM SAL_UP_SALARY WHERE POSTYPE_ID = 3 AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND ORG_ID_3 = '".$rec['ORG_ID']."' ");
