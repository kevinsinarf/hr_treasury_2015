...
WHERE A.ORG_ID_3= '".$ORG_ID_3."' AND A.POSTYPE_ID = '5'";
...
<script src="js/command_up_salary_4_disp.js?<?php echo rand(); ?>"></script>
</head>
...
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
        <ol class="breadcrumb">
          ...
          <li><a href="command_up_salary4_disp.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id."&YEAR_BDG=".$YEAR_BDG."&ROUND=".$ROUND."&proc=".$proc."&SAL_COM_ID=".$SAL_COM_ID);?>"><?php echo Showmenu($menu_sub_id);?></a></li>
          <li><a href="command_up_salary4_form.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id."&YEAR_BDG=".$YEAR_BDG."&ROUND=".$ROUND."&proc=".$proc."&SAL_COM_ID=".$SAL_COM_ID);?>"><?php echo $txt; ?></a></li>
	...
	<div class="col-xs-12 col-md-12">
		<div class="groupdata">
			<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					...
					<div class="table-responsive">
                        <table width="397" class="table table-bordered table-striped table-hover table-condensed">
                          <thead>
                              ...
                              <th width="25%"  style="text-align:center; vertical-align:middle" ><strong>ระดับตำแหน่ง</strong></th>
                ...
                <button type="button" class="btn btn-primary" onClick="self.location.href='command_up_salary4_form.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id."&YEAR_BDG=".$YEAR_BDG."&ROUND=".$ROUND."&proc=".$proc."&SAL_COM_ID=".$SAL_COM_ID);?>';">ย้อนกลับ</button></button>
                </div>
			</form>
		</div>
	</div>
