...
$table="SAL_COMMAND ";
$pk_id="SAL_COM_ID";
$wh="DELETE_FLAG ='0' AND POSTYPE_ID ='3' AND MOVEMENT_ID = 23 {$filter} ";
...
//echo "select ".$field." from ".$table." where ".$wh;
?>
<!DOCTYPE html>
<html>
<head>
...
<script src="js/command_temp_salary_emp_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
