...
FROM SAL_SCORE 
WHERE  POSTYPE_ID= '3' AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND   SCORE_STATUS = 1 
ORDER BY SCORE_ID ASC");
$query_num = $db->query("SELECT COUNT(SCORE_ID) AS NUM_SCORE FROM SAL_SCORE WHERE POSTYPE_ID = '3' AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."'   AND SCORE_STATUS = 1 AND CONFIRM_TYPE = 2 ");
...
<script src="js/set_level_salary2_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
