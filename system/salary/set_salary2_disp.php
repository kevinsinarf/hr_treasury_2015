...
$query = $db->query("SELECT * FROM SAL_STEP WHERE LEVEL_ID = '".$S_LEVEL."'");
...
<script src="js/set_salary2_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
		...
		<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-2">
              		<?php echo GetHtmlSelect('S_LEVEL','S_LEVEL',$arr_level,'กลุ่มงาน',$S_LEVEL,'','','1','','2');?>
                </div>
			...
			<div class="table-responsive">
                <table align="center" class="table table-bordered table-striped table-hover table-condensed" id="tb_data">
                    <thead>
                    	<tr class="bgHead" >
                          <th width="30%" ><div align="center"><strong>ลำดับขั้น</strong></div></th>
                          <th width="30%" ><div align="center"><strong>อัตรา (บาท/เดือน)</strong></div></th>
