...
$link2 = "menu_id=".$menu_id."&PER_ID=".$PER_ID."&menu_sub_id=".$menu_sub_id."&PT_ID=".$PT_ID;
...
<script src="js/salary_leve_his_gov_per_form.js?<?php echo rand(); ?>"></script>
</head>
<body>
...
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12">
    <ol class="breadcrumb">
	  ...
	  <li><a href="salary_leve_his_gov_per_disp.php?<?php echo url2code($link2); ?>">ประวัติการลา</a></li>
...
<div class="groupdata" > <br>
	<?php include ("tab_info.php"); ?>
     <div class="clearfix"></div>
   	 <form id="frm-input" method="post" action="process/salary_leave_his_gov_per_process.php" enctype="multipart/form-data">
        ...
        <input type="hidden" id="ROUND_YEAR" name="ROUND_YEAR" value="<?php echo $ROUND_YEAR; ?>">
         ...
         <div class="row formSep">  
              <div class="col-xs-12 col-md-2" >ปีงบประมาณ</div>
              <div class="col-xs-12 col-md-2" ><?php echo $LEAVEHIS_YEAR; ?></div>
              <div class="col-xs-12 col-md-2" >รอบ</div> 
              <div class="col-xs-12 col-md-2" ><?php echo $arr_round_leave[$ROUND_YEAR]; ?></div>
        
        </div>
		
                <div class="row head-form">
                    <div class="col-md-4" style="white-space:nowrap;">ประเภทการลา</div> 
                    <div class="col-md-4" style="white-space:nowrap;">จำนวนครั้งที่ลา</div>
                    <div class="col-md-4" style="white-space:nowrap;">จำนวนวันที่ลา</div>
...
<div class="row formSep">
 <div class="col-md-4" style="white-space:nowrap;">
        ...
        <div class="col-xs-12 col-sm-12" align="center">
			...
			<button type="button" class="btn btn-default" onClick="self.location.href='salary_leve_his_gov_per_disp.php?<?php echo url2code($link2);?>';">ยกเลิก</button>
        </div>
        </div>
        <br>
    </form>
