...
$field="A.SAL_UP_ID, B.PER_IDCARD, A.POS_NO, A.NAME, C.LINE_NAME_TH, D.LEVEL_NAME_TH, E.MANAGE_NAME_TH, A.SALARY_NOW ";
...
$pk_id="A.SAL_UP_ID";
$wh=" A.POSTYPE_ID = 1 AND A.YEAR_BDG = '".$S_YEAR_BDG."' AND A.ROUND = '".$S_ROUND."' AND A.ORG_ID_3 = '".$ORG_ID_3."' AND A.SAL_UP_TYPE = 1 {$filter} ";
$groupby = "  "; 
...
<script src="js/setup_per_group_gov_form.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
	...
	<div class="col-xs-12 col-sm-12">
		<ol class="breadcrumb">
			...
			<li class="active"><a href="#" onClick=" $('#page').val(1); $('#frm-search').attr('action','setup_per_group_gov_disp.php').submit(); ">ข้าราชการ->จัดกลุ่มสำหรับการเลื่อนเงินเดือน</a></li>
	...
	<div class="col-xs-12 col-sm-12" id="content">
		...
		<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-md-3"><?php echo $S_ROUND; ?></div>
			</div>
            <div class="row">
            	...
            	<div class="row">
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-2">
                          <select id="S_LEVEL_ID" name="S_LEVEL_ID" class="selectbox form-control" placeholder="-ทั้งหมด-" >
                              ...
                              $sql_level_name = "Select LEVEL_ID , LEVEL_NAME_TH  From SETUP_POS_LEVEL WHERE ACTIVE_STATUS = 1 AND POSTYPE_ID = '1' AND DELETE_FLAG = '0'".$cond_level." ORDER BY LEVEL_SEQ ASC";
                     ...
                     <div class="col-xs-12 col-md-2" style="white-space:nowrap;">สายงาน :</div>
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-2">                                        
                          <select id="S_LINE_ID" name="S_LINE_ID" class="selectbox form-control" placeholder="-ทั้งหมด-" >
                              <option value=""></option>
                              <?php
                              $sql_line_name="SELECT LINE_ID , LINE_NAME_TH FROM SETUP_POS_LINE WHERE DELETE_FLAG='0' AND POSTYPE_ID = '1' AND LG_ID = '".$S_LG_ID."' ORDER BY LINE_NAME_TH ASC";
                ...
                <table align="center" class="table table-bordered table-striped table-hover table-condensed" id="tb_data">
                    <thead>
                        <tr class="bgHead">
                            ...
                            <th width="15%"><div align="center"><strong>ตำแหน่งทางการบริหาร (ถ้ามี)</strong></div></th>
					...
					while($rec = $db->db_fetch_array($query)){
						$PER_NAME = htmlspecialchars_decode($rec['NAME']);
                        ...
                        <tr>
                            ...
                            <td align="left"><?php echo text($PER_NAME);?></td>
