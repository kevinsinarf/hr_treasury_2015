...
$url_back="../set_level_score_mg_disp.php";
$table = "SAL_SCORE";

switch($proc){	
	case 'save' :
		try{
			$db->db_delete($table," POSTYPE_ID= '1' AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND SCORE_STATUS = 2 ");
	...
	case 'ConfirmMg':
		try{	
		   ...
		   $db->db_update($table,array('CONFIRM_TYPE' => 2)," YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND SCORE_STATUS = 2 "); 
