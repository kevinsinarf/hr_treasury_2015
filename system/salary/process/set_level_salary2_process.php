...
$url_back="../set_level_salary2_disp.php";
$table = "SAL_SCORE";

switch($proc){	
	case 'save' :
		try{
			$db->db_delete($table," POSTYPE_ID= '3' AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."'  AND SCORE_STATUS = 1 ");
	...
	case 'ConfirmEmp':
		try{	
		   ...
		   $db->db_update($table,array('CONFIRM_TYPE' => 2)," POSTYPE_ID = 3  AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND SCORE_STATUS = 1 "); 
