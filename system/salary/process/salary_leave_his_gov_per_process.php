...
$url_back="../salary_leve_his_gov_per_disp.php";
$table="PER_LEAVEHIS"; 
...
if(empty($_POST['LEAVEHIS_IMPORTANT_SICK_TIME'])){ $LEAVEHIS_IMPORTANT_SICK_TIME= 0; }else{ $LEAVEHIS_IMPORTANT_SICK_TIME = $_POST['LEAVEHIS_IMPORTANT_SICK_TIME'];}
if(empty($_POST['LEAVEHIS_IMPORTANT_SICK_DAY'])){ $LEAVEHIS_IMPORTANT_SICK_DAY = 0; }else{ $LEAVEHIS_IMPORTANT_SICK_DAY = $_POST['LEAVEHIS_IMPORTANT_SICK_DAY'];}
...
$ROUND_YEAR = (int)$_POST['ROUND_YEAR'];
...
switch($proc){
	case "add" : 
		try{
			...
			(int)$chk = $db->get_data_field($sql_chk,"nums");   
			if($chk== 0){
				$fields = array(
					"LEAVEHIS_YEAR" => $LEAVEHIS_YEAR ,
					"LEAVEHIS_SICK_TIME" => (int)$LEAVEHIS_SICK_TIME,
					"LEAVEHIS_SICK_DAY" =>  $LEAVEHIS_SICK_DAY,	
					"LEAVEHIS_IMPORTANT_SICK_TIME" => $LEAVEHIS_IMPORTANT_SICK_TIME,
				    "LEAVEHIS_IMPORTANT_SICK_DAY" => $LEAVEHIS_IMPORTANT_SICK_DAY,	
	...
	break;
	case 'chk':
	$sql_chk = "select count(*) as nums from ".$table." where LEAVEHIS_YEAR = '".$_POST['LEAVEHIS_YEAR']."' AND ROUND_YEAR = '".$ROUND_YEAR."' AND  PER_ID = ".$PER_ID."  ";  
	(int)$chk = $db->get_data_field($sql_chk,"nums"); 
	echo $chk;
	exit;  
	break;
