...
$url_back="../set_level_salary1_disp.php";
$table = "SAL_SCORE";

switch($proc){	
	case 'save' :
		try{
			$db->db_delete($table," POSTYPE_ID= '1' AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND ORG_ID_3 = '".$S_ORG3."' AND SCORE_STATUS = 1 ");
	...
	case 'ConfirmGov':
		try{	
		   ...
		   $db->db_update($table,array('CONFIRM_TYPE' => 2)," POSTYPE_ID = 1 AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND SCORE_STATUS = 1 AND ORG_ID_3 = '".$S_ORG3."' "); 
...
<form name="form_back" method="post" action="<?php echo $url_back;?>">
	...
	<input type="hidden" id="S_ORG3" name="S_ORG3" value="<?php echo $S_ORG3;?>" />
	<input type="hidden" id="S_ORG4" name="S_ORG4" value="<?php echo $S_ORG4;?>" />
