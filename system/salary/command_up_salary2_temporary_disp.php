...
$table="SAL_COMMAND ";
$pk_id="SAL_COM_ID";
$wh="DELETE_FLAG ='0' AND POSTYPE_ID ='1' AND MOVEMENT_ID = 17 {$filter} ";
...
<script src="js/command_up_salary_2_temporary_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
  ...
  <div class="col-xs-12 col-sm-12">
    <ol class="breadcrumb">
      ...
      <li class="active">จัดทำคำสั่ง->ข้าราชการ-><?php echo Showmenu($menu_sub_id);?></li>
    </ol>
  </div>
