...
WHERE A.ORG_ID_3= '".$ORG_ID_3."' AND A.POSTYPE_ID = '1'";
...
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
        <ol class="breadcrumb">
          ...
          <li><a href="command_up_salary2_disp.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id."&YEAR_BDG=".$YEAR_BDG."&ROUND=".$ROUND."&proc=".$proc."&SAL_COM_ID=".$SAL_COM_ID);?>"><?php echo Showmenu($menu_sub_id);?></a></li>
          <li><a href="command_up_salary2_form.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id."&YEAR_BDG=".$YEAR_BDG."&ROUND=".$ROUND."&proc=".$proc."&SAL_COM_ID=".$SAL_COM_ID);?>"><?php echo $txt; ?></a></li>
