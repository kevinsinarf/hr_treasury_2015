...
FROM SAL_SCORE 
WHERE  POSTYPE_ID= '1' AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND ORG_ID_3 = '".$S_ORG3."' AND  SCORE_STATUS = 1 
ORDER BY SCORE_ID ASC");
$query_num = $db->query("SELECT COUNT(SCORE_ID) AS NUM_SCORE FROM SAL_SCORE WHERE POSTYPE_ID = '1' AND YEAR_BDG = '".$S_YEAR_BDG."' AND ROUND = '".$S_ROUND."' AND ORG_ID_3 = '".$S_ORG3."'  AND SCORE_STATUS = 1 AND CONFIRM_TYPE = 2 ");
...
<script src="js/set_level_salary1_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
	...
	<div class="col-xs-12 col-sm-12" id="content">
		...
		<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
            ...
            <div class="row">
				...
				<div class="col-xs-12 col-md-3"><?php echo GetHtmlSelect('S_ORG3','S_ORG3',$arr_org3,'สำนัก/กลุ่ม',$S_ORG3,"onchange=\"getOrgParent(this.value); $('#frm-search').submit();\" ",'','1','','2');?></div>
		      </div>
