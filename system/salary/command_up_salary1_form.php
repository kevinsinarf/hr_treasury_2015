...
$sql=  " SELECT SAL_COM_ID,YEAR_BDG ,ROUND,COM_NO,COM_DATE,COM_TITLE,COM_SDATE,CREATE_BY,UPDATE_BY,CREATE_DATE,UPDATE_DATE,POSTYPE_ID FROM SAL_COMMAND WHERE  SAL_COM_ID ='".$SAL_COM_ID."' ";
$query = $db->query($sql);
$rec = $db->db_fetch_array($query);

$sql_sal_up ="SELECT SUM(SALARY_NEW) AS SALARY_SUM, COUNT(PER_ID) AS PERSONAL, B.MANAGE_NAME_TH, A.MANAGE_ID
FROM SAL_UP_SALARY A
LEFT JOIN SETUP_POS_MANAGE B ON A.MANAGE_ID = B.MANAGE_ID
WHERE A.MANAGE_ID > 0 AND YEAR_BDG = '".$YEAR_BDG."' AND ROUND = '".$ROUND."' 
AND (A.SAL_COM_ID != '' or A.SAL_COM_ID IS NULL or A.SAL_COM_ID != 0) 
GROUP BY A.MANAGE_ID, B.MANAGE_NAME_TH ORDER BY B.MANAGE_NAME_TH";
...
WHERE MANAGE_ID > 0 AND YEAR_BDG = '".$YEAR_BDG."' AND ROUND = '".$ROUND."' GROUP BY ORG_ID_3, B.ORG_NAME_TH ORDER BY B.ORG_NAME_TH"));
...
<script src="js/command_up_salary_1_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
    ...
    <div class="col-xs-12 col-sm-12">
        <ol class="breadcrumb">
          ...
          <li><a href="command_up_salary1_disp.php?<?php echo url2code("menu_id=".$menu_id."&menu_sub_id=".$menu_sub_id);?>"><?php echo Showmenu($menu_sub_id);?></a></li>
          <li class="active"><?php echo $txt;?></li>
        </ol>
    </div>
    <div class="col-xs-12 col-sm-12" id="content">
        <div class="groupdata" >
		<form id="frm-input" method="post" action="process/command_up_salary1_process.php">
        ...
        <div class="row">
         ...
         <div class="row ">
            ...
            <div class="col-xs-12 col-md-3"><?php echo GetHtmlSelect('MOVEMENT_ID', 'MOVEMENT_ID', $arr_movement, 'ประเภทความเคลื่อนไหว' ,$rec_edit['MOVEMENT_ID'] ,'', '', '', '300', '1'); ?></div>  
        </div>
		<div class="row">
				...
				<div class="col-xs-12 col-md-12">
					<div class="table-responsive">
						<table class="table table-bordered table-striped table-hover table-condensed">
							<thead>							
								<tr class="bgHead">
									<th width="40%"><div align="center"><strong>ตำแหน่งทางการบริหาร</strong></div></th>
									...
									<th width="10%"><div align="center"><strong>ดูรายละเอียด</strong></div></th>
								</tr>
							</thead>
							<tbody>
							<?php
							if ($nums > 0) {
								...
								while($rec_sal_up= $db->db_fetch_array($query_sal_up)) {
									$edit = "<a data-toggle=\"modal\" class=\"btn btn-default btn-xs\" data-backdrop=\"static\" href=\"javascript:void(0);\" onClick=\"View('".$rec_sal_up["MANAGE_ID"]."');\">".$img_save." ดูรายละเอียด</a> ";
								 	?>
									<tr bgcolor="#FFFFFF">
                                        <td align="left"><?php echo text($rec_sal_up['MANAGE_NAME_TH']); ?>
