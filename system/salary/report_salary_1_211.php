...
<?php
$arr_org = array();
$where_is = " WHERE A.YEAR_BDG = '".$AGE_IS."' AND A.ROUND = '".$ROUND."'   AND A.POSTYPE_ID =1 ";
if($NAME !=""){ 
...
$nums = $db->db_num_rows($query);  
	        ...
	        $all_btn = " <form id='frm-exportall' method='post' action='".$_SERVER['PHP_SELF']."?v=23423' target=_blank>
							 <button type='button' tclass='btn btn-primary dropdown-toggle'  onclick='print_pdf211(0);return false;' >
