...
$table="SAL_COMMAND ";
$pk_id="SAL_COM_ID";
$wh="DELETE_FLAG ='0' AND POSTYPE_ID ='1' AND MOVEMENT_ID = 16 {$filter} ";
...
<script src="js/command_up_salary2_spe_disp.js?<?php echo rand(); ?>"></script>
</head>
<body>
    ...
    <div class="groupdata">
      <form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-2 " style="white-space:nowrap;">รอบ : <span style="color:red;">*</span></div>
