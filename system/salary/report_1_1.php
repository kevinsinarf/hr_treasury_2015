...
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li class="active">ข้าราชการ (รายงานโควต้าการเลื่อนขั้นเงินเดือน ณ วันที่ 1 เมษายน ร้อยละ 15 และ ณ วันที่ 1 ตุลาคม ร้อยละ 6)</li>
		</ol>
	</div>
	<div class="col-xs-12 col-md-12">
		<div class="groupdata">
				...
				<div class="col-xs-12 col-md-12">
					<div class="table-responsive">
						<table class="table table-bordered table-striped table-hover table-condensed">
							<thead>							
								<tr class="bgHead">
									<th width="35%"><div align="center"><strong>สำนัก</strong></div></th>
									<th width="35%"><div align="center"><strong>จำนวนอัตรา </strong></div></th>
									<th width="30%"><div align="center"><strong>จำนวนอัตราร้อยละ</strong></div></th>
								</tr>
							</thead>
							<tbody>
							<?php
							/*if ($nums > 0) {
								...
								while($rec= $db->db_fetch_array($query)) {*/
								 ...
								 ?>
								<tr bgcolor="#FFFFFF">
									<td align="left">สำนัก A</td>
									<td align="center">30</td>
									<td align="center">42.86%</td>
								</tr>
								<tr bgcolor="#FFFFFF">
									<td align="left">สำนัก B</td>
							...
							<thead>
								<tr class="bgHead">
									<th width="35%"><div align="center"><strong>รวมจำนวนอัตรา</strong></div></th>
									<th width="35%"><div align="center"><strong>70 </strong></div></th>
									<th width="30%"><div align="center"><strong>100%</strong></div></th>
								</tr>
							</thead>
						</table>
					</div>
