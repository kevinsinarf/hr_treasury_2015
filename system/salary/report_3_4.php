...
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li class="active">พนักงานราชการ (รายงานคำสั่งเลื่อนขั้นเงินเดือน)</li>
		</ol>
	</div>
	<div class="col-xs-12 col-md-12">
		<div class="groupdata">
			<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-3"><input type="text" id=order_no" name="order_no" class="form-control" placeholder="เลขที่คำสั่ง" value="<?php echo ($_POST['order_no']?$_POST['order_no']:$order_no); ?>"></div>
					<div class="col-xs-12 col-md-2 col-md-offset-1" style="white-space:nowrap;">หนังสือคำสั่งเลขที่ :</div>
