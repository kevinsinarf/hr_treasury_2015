...
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li class="active">ข้าราชการ (รายงานการประเมินผลสัมฤทธิ์ และ สมรรถนะหลัก)</li>
		</ol>
	</div>
	<div class="col-xs-12 col-md-12">
		<div class="groupdata">
						...
						<table class="table table-bordered table-striped table-hover table-condensed">
							<thead>							
								<tr class="bgHead">
									...
									<th width="15%"><div align="center"><strong>ตำแหน่ง</strong></div></th>
									<th width="15%"><div align="center"><strong>สำนัก</strong></div></th>
									<th width="15%"><div align="center"><strong>กลุ่มงาน</strong></div></th>
									<th width="10%"><div align="center"><strong>คะแนนผลสัมฤทธิ์</strong></div></th>
									<th width="10%"><div align="center"><strong>คะแนนสมรรถนะหลัก</strong></div></th>
									<th width="10%"><div align="center"><strong>ผลรวมคะแนนประเมิน</strong></div></th>
								</tr>
							</thead>
							<tbody>
							<?php
