...
<div class="container-full">
	...
	<div class="col-xs-12 col-md-12">
		<ol class="breadcrumb">
			...
			<li class="active">พนักงานราชการ (รายงานการเลื่อนขั้นเงินเดือน)</li>
		</ol>
	</div>
	<div class="col-xs-12 col-md-12">
		<div class="groupdata">
			<form id="frm-search" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<input type="hidden" id="page_size" name="page_size" value="<?php echo $page_size; ?>">
						<? include ("inc.head.report2.php"); // form รายงาน ?>
				<div class="row">
						...
						<table class="table table-bordered table-striped table-hover table-condensed">
							<thead>							
								<tr class="bgHead">
									...
									<th width="5%"><div align="center"><strong>ระดับคะแนน</strong></div></th>
									...
									<th width="5%"><div align="center"><strong>ร้อยละที่ได้เลื่อน</strong></div></th>
									<th width="5%"><div align="center"><strong>จำนวนเงินที่ได้เลื่อน</strong></div></th>
