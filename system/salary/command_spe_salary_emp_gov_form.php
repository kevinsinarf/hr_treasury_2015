...
if($proc == 'edit'){
 ...
 $sql = "SELECT B.PER_IDCARD,B.PREFIX_ID,B.PER_ID,B.PER_FIRSTNAME_TH,B.PER_MIDNAME_TH, B.PER_LASTNAME_TH ,B.POS_NO,
			...
			WHERE A.YEAR_BDG = '".$YEAR_BDG."' AND ROUND = '".$ROUND."' AND A.POSTYPE_ID = 5 AND A.SALARY_SPE_UP > 0  ";
$query = $db->query($sql);
$nums = $db->db_num_rows($query);

$arr_command_type = GetSqlSelectArray("CT_ID", "CT_NAME_TH", "SETUP_COMMAND_TYPE", " LT_ID = '8' AND ACTIVE_STATUS = 1 ", "CT_NAME_TH");
$arr_movement = GetSqlSelectArray("MOVEMENT_ID", "MOVEMENT_NAME_TH", "SETUP_MOVEMENT", " MOVEMENT_ID = 27  ", "MOVEMENT_NAME_TH");
?>
<!DOCTYPE html>
<html>
<head>
...
<script src="js/command_spe_salary_emp_gov_form.js?<?php echo rand(); ?>"></script>
</head>
<body>
<div class="container-full">
    ...
    <div class="col-xs-12 col-sm-12" id="content">
        <div class="groupdata" >
		<form id="frm-input" method="post" action="process/command_spe_salary_emp_gov_process.php">
        ...
        <div class="row formSep">
            ...
            <div class="col-xs-12 col-sm-3"><?php echo $arr_emp_gov_round[$ROUND]; ?></div>
        </div>
         <div class="row formSep">
            ...
            <div class="col-xs-12 col-md-3">
			  <?php echo text($arr_movement['27']); ?>
              <input type="hidden" id="MOVEMENT_ID" name="MOVEMENT_ID" value="27">
            </div> 
        </div>
		<div class="row formSep">
                        ...
                        <thead>
						 ...
						 if($nums > 0){
							...
							while($rec = $db->db_fetch_array($query)){
								...
								$POS_DETAIL .= "<br><strong>กลุ่มงาน : </strong>".text($rec['TYPE_NAME_TH']);
