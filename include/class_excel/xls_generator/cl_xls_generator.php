...
//		20 Feb 2004 - build 1.31

$delim = ":";
if (preg_match("/\\\/",$_SERVER["PATH"])) {$delim = ";";}
@ini_set("include_path",ini_get("include_path").$delim.".");

require_once "hdr_xls.php";
require_once "cl_xls_book.php";
require_once "cl_xls_sheet.php";
require_once "cl_xls_format.php";
require_once "cl_xls_formula.php";
require_once "cl_xml2xls.php";
require_once "cl_storage.php";
...
// RECORD - CONTINUE
	function _get_continue($data) {
		...
		8235			2			1234H				16-bit character “Ø”
